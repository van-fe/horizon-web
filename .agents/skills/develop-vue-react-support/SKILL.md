...
- Do not mark a renderer package migration complete until the shared component Skill's renderer file-structure and Hook/Composable gates pass; separate packages containing monolithic components, catch-all hooks or setup-time snapshots of reactive inputs are still incomplete.
