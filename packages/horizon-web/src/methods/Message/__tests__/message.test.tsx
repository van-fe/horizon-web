...
describe('Message.tsx', () => {
  ...
  describe('test props', () => {
    ...
    test('loading message', async () => {
      ...
      await nextTick();
      expect(document.body.innerHTML).toMatchInlineSnapshot(
        `"<div class="container_message_5"><div style="top: 32px; z-index: 2005;" class="h-message is-loading h-message-fade-enter-from h-message-fade-enter-active"><svg class="a-icon h-icon_loading_line h-icon__loading_line h-message__status-icon" viewBox="0 0 24 24" fill="none" style="display: inline-block; vertical-align: inherit;"><path d="M15.1562 20.6723C10.3661 22.4163 5.07092 19.9452 3.32801 15.1528C1.5851 10.3609 4.05397 5.06246 8.84405 3.31785C9.32269 3.14364 9.85301 3.39049 10.0271 3.86943C10.2012 4.34837 9.9539 4.87901 9.47588 5.05323C5.64308 6.4488 3.66823 10.6878 5.06293 14.5218C6.45762 18.3551 10.6934 20.3318 14.525 18.9369C18.3572 17.5413 20.332 13.3023 18.9373 9.46832C17.9583 6.77641 15.5772 5.0069 12.9199 4.67211C12.4149 4.60848 12.0005 4.20188 12.0001 3.69285C11.9998 3.18325 12.414 2.76521 12.921 2.81624C16.3342 3.15973 19.4195 5.3951 20.6716 8.8361C22.4145 13.6292 19.9456 18.9276 15.1562 20.6723Z" fill="var(--h-message-color--loading-icon)"></path></svg><p class="h-message__content h-message__plaintext">loading test<svg class="a-icon h-icon_more_two h-icon__more_two h-message__ellipsis" viewBox="0 0 24 24" fill="none" style="width: 1em; height: 1em; font-size: 1em; display: inline-block; vertical-align: inherit;"><path d="M4 10.7502C4.69036 10.7502 5.25 11.3099 5.25 12.0002C5.25 12.6906 4.69036 13.2502 4 13.2502C3.30964 13.2502 2.75 12.6906 2.75 12.0002C2.75 11.3099 3.30964 10.7502 4 10.7502Z" fill="currentColor"></path><path d="M12 10.7502C12.6904 10.7502 13.25 11.3099 13.25 12.0002C13.25 12.6906 12.6904 13.2502 12 13.2502C11.3096 13.2502 10.75 12.6906 10.75 12.0002C10.75 11.3099 11.3096 10.7502 12 10.7502Z" fill="currentColor"></path><path d="M21.25 12.0002C21.25 11.3099 20.6904 10.7502 20 10.7502C19.3096 10.7502 18.75 11.3099 18.75 12.0002C18.75 12.6906 19.3096 13.2502 20 13.2502C20.6904 13.2502 21.25 12.6906 21.25 12.0002Z" fill="currentColor"></path></svg></p><!----></div></div>"`,
      );
