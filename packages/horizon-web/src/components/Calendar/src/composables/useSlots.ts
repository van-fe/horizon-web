...
export const useCalendarSlots = Object as SlotsType<{
   ...
   * @paramEn rawDate The raw date value.
    * @en Custom content for the switch date slot.
   */
   ...
   * @param rawDate 原始Dayjs对象
   * @paramEn rawDate The raw date value.
    * @en Custom content for the date cell slot.
   */
   ...
   * @param rawDate 原始Dayjs对象
   * @paramEn rawDate The raw date value.
    * @en Custom content for the date cell title slot.
   */
   ...
   * @param rawDate 原始Dayjs对象
   * @paramEn rawDate The raw date value.
    * @en Custom content for the date cell append slot.
   */
   ...
   * @paramEn rawDate The raw date value.
    * @en Custom content for the month header slot.
   */
   ...
   * @paramEn isToday The is today value.
    * @en Custom content for the week day header slot.
   */
   ...
   * @param isToday 是否是当前所在天
   * @paramEn isToday The is today value.
    * @en Custom content for the day header slot.
   */
  dayHeader?: (date: string, rawDate: Dayjs, isToday: boolean) => Arrayable<VNode>;
  /**
   * 时区显示插槽
   * @param timezone 当前时区偏移量
   * @paramEn timezone The timezone value.
   * @param date 根据 `format` 做的格式转换后的当前日期
   * @paramEn date The date value.
   * @param rawDate 原始Dayjs对象
   * @paramEn rawDate The raw date value.
    * @en Custom content for the timezone slot.
   */
