...
describe('@aurora/icon compatibility', () => {
  it('renders AIcon content synchronously on the client and server', async () => {
    ...
    expect(wrapper.classes()).toEqual(expect.arrayContaining(['a-icon', 'h-icon_add', 'h-icon__add']))
  ...
  it('applies compatible classes and spin animation to generated icons', () => {
