...
import type { ApplicationPopupContainerGetter } from '@aurora/horizon-core';
...
export type HorizonWebProviderProps = PropsWithChildren<
  ...
  > & {
    ...
    calendarLabels?: Partial<HorizonWebConfig['calendarLabels']>;
