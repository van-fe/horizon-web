...
describe('Drawer.tsx', () => {
  ...
  test<LocalTestContext>('Drawer default #render', async ctx => {
    ...
    visible.value = true;
    await nextTick();
    expect(normalizeDrawerHtml(ctx.teleportEl.innerHTML)).toMatchInlineSnapshot(
      `"<div class="h-drawer" style="position: absolute; z-index: 2002;"><transition-stub name="h-fade-in-normal" duration="300" appear="true" persisted="false" css="true"><div class="h-drawer__mask" style="z-index: inherit; position: absolute;"></div></transition-stub><transition-stub name="h-drawer-slide-right" appear="true" persisted="false" css="true"><div role="dialog" aria-modal="true" aria-labelledby="v-0" tabindex="-1" class="h-drawer__container h-drawer--right" style="z-index: 2003; width: 418.667px; height: 100%; position: absolute;"><div class="h-drawer__main"><div id="v-0" class="h-drawer__header h-drawer__header--customize"><div class="h-drawer__default-title">drawer title</div><button class="h-button h-button--normal h-button--small h-button--text h-button--equally is-solid is-with-icon h-drawer__closable h-drawer__closable" type="button" tabindex="0" aria-label="Close drawer"><div class="h-button__icon is-custom-size"><svg class="a-icon h-icon_close h-icon__close" viewBox="0 0 24 24" fill="none" style="width: 16px; height: 16px; font-size: 16px; display: inline-block; vertical-align: inherit;"><path d="M11.9999 10.9517L19.9429 3C20.5267 3.58446 20.5267 4.53206 19.9429 5.11652L13.057 12.01L21 19.9617C20.4162 20.5461 19.4696 20.5461 18.8858 19.9617L11.9999 13.0682L5.11419 19.9615C4.53038 20.546 3.58382 20.546 3 19.9615L10.9428 12.01L4.0571 5.11664C3.47328 4.53217 3.47328 3.58458 4.0571 3.00011L11.9999 10.9517Z" fill="currentColor"></path></svg></div><!----><!----></button></div><div class="h-drawer__body"><div>drawer content</div></div><div class="h-drawer__footer"><div class="h-drawer__default-footer"><button class="h-button h-button--normal h-button--medium h-button--plain is-solid" type="button" tabindex="0"><!----><div class="h-button__content"><!----></div><!----></button><button class="h-button h-button--primary h-button--medium is-solid" type="button" tabindex="0" style="margin-left: var(--h-spacing-5);"><!----><div class="h-button__content"><!----></div><!----></button></div></div><!----></div></div></transition-stub></div>"`,
    );
  ...
  test('Drawer destroyOnClose #props', async () => {
    ...
    expect(normalizeDrawerHtml(wrapper.html())).toMatchInlineSnapshot(`
      "<!--teleport start-->
      <div class="h-drawer" style="position: absolute; z-index: 2009;">
        ...
        <transition-stub name="h-drawer-slide-right" appear="true" persisted="true" css="true">
          <div role="dialog" aria-modal="true" aria-labelledby="v-0" tabindex="-1" class="h-drawer__container h-drawer--right" style="z-index: 2010; width: 418.667px; height: 100%; position: absolute;">
            <div class="h-drawer__main">
              <div id="v-0" class="h-drawer__header h-drawer__header--customize">
                <div class="h-drawer__default-title">
                  <!---->
                </div><button class="h-button h-button--normal h-button--small h-button--text h-button--equally is-solid is-with-icon h-drawer__closable h-drawer__closable" type="button" tabindex="0" aria-label="Close drawer">
              ...
              <div class="h-drawer__footer">
                <div class="h-drawer__default-footer"><button class="h-button h-button--normal h-button--medium h-button--plain is-solid" type="button" tabindex="0">
                    <!---->
                    <div class="h-button__content">
                      <!---->
                    </div>
                    <!---->
                  </button><button class="h-button h-button--primary h-button--medium is-solid" type="button" tabindex="0" style="margin-left: var(--h-spacing-5);">
                    <!---->
                    <div class="h-button__content">
                      <!---->
                    </div>
