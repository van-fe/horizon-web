...
import type { TreeSelectCommandMap } from '@aurora/core';

type TreeSelectVueCommands = TreeSelectCommandMap<HTreeData>;
...
export const useTreeSelectExposes = {
   ...
   */
  confirmHandle: Function as ExposeType<TreeSelectVueCommands['confirm']>,
  /**
   * 手动处理取消操作，只有在 `need-confirm = true` 时有效
   * @en Controls cancel handle.
   */
  cancelHandle: Function as ExposeType<TreeSelectVueCommands['cancel']>,
  /**
   * 控制面板是否展示
   * @en Controls change panel visible.
   */
  changePanelVisible: Function as ExposeType<TreeSelectVueCommands['setOpen']>,
  /**
   * 获取选中状态所有节点
   *
   * @return values 选中的值
   ...
   */
  clearSelectedValues: Function as ExposeType<TreeSelectVueCommands['clearSelectedValues']>,
   ...
   */
  scrollTo: Function as ExposeType<TreeSelectVueCommands['scrollTo']>,
};
