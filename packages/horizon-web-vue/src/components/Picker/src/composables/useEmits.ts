...
type PickerVueEvents = AdaptComponentApiShape<
  PickerEventMap<string, Event>,
  { valueChange: 'update:modelValue'; keyDown: 'keydown' },
  'openChange'
>;
...
export const usePickerEmits = {
  ...
  Omit<PickerVueEvents, 'focus' | 'blur' | 'click' | 'keyDown' | 'confirm' | 'cancel' | 'clear'> & {
    focus: [];
    blur: [];
    click: [evt: MouseEvent];
    keydown: [evt: KeyboardEvent];
    confirm: [evt?: MouseEvent];
    cancel: [evt?: MouseEvent];
    clear: [evt: MouseEvent];
    inputFocus: [evt: FocusEvent];
    inputBlur: [evt: FocusEvent];
