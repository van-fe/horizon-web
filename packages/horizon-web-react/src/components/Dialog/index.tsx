...
import type { DialogInteractionLayer, PortalTarget } from '@aurora/horizon-web-core';
import { createDialogInteractionLayer, resolvePortalContainer } from '@aurora/horizon-web-core';
