import type { AvatarEventMap, ComponentEventArguments } from '@aurora/core';

type AvatarErrorArguments = ComponentEventArguments<AvatarEventMap<Event>, 'error'>;
...
export const useAvatarEmits = {
   ...
   */
  error: (...[evt]: AvatarErrorArguments) => evt instanceof Event,
};
