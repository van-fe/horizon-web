...
export const useUploadProps = declarePropType({
  ...
  /**
   * 覆盖默认的上传函数
   * 需参考 [uploadFileDirectly](https://git.nevint.com/horizon-web/horizon-web/-/blob/master/packages/horizon-vue/src/components/Upload/src/utils/UploadHelper.ts) 的行为
