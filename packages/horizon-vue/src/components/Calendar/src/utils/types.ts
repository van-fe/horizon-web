...
import type { CalendarPinFlag, CalendarPinFlagType } from '@aurora/core';

export interface HCalendarPinFlag extends CalendarPinFlag<string | VNode, Date | string | Dayjs> {
  /**
   * 唯一识别 ID
   * @invisible
   */
