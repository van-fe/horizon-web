...
export const useCalendarProps = declarePropType({
  ...
  mode: {
    ...
    default: CALENDAR_DEFAULTS.mode,
    validator: isCalendarMode,
  },
  /**
   * 是否允许切换显示类型
  ...
  modeSwitchable: {
    type: Boolean,
    default: CALENDAR_DEFAULTS.modeSwitchable,
  },
  /**
   * 允许切换显示类型的列表
  ...
  modeSwitchableList: {
    ...
    default: () => [...CALENDAR_DEFAULTS.modeSwitchableList],
    validator: isCalendarModeList,
  },
  /**
   * 默认开始展示小时
  ...
  defaultStartHour: {
    type: Number,
    default: CALENDAR_DEFAULTS.defaultStartHour,
    validator: isCalendarStartHour,
  },
  /**
   * 日期格式化，会影响回调的日期格式
  ...
  format: {
    type: String,
    default: CALENDAR_DEFAULTS.format,
  },
  /**
   * 日期显示方式
   * `full`: 全部展示（默认）
  ...
  dateType: {
    ...
    default: CALENDAR_DEFAULTS.dateType,
    validator: isCalendarDateType,
  },
  /**
  ...
  hourFormat: {
    ...
    default: CALENDAR_DEFAULTS.hourFormat,
    validator: isCalendarHourFormat,
  },
  /**
   * 是否允许选择日期或时间
  ...
  pickable: {
    type: Boolean,
    default: CALENDAR_DEFAULTS.pickable,
  },
  /**
   * 是否允许创建横幅
  ...
  enableCreatePinFlags: {
    type: Boolean,
    default: CALENDAR_DEFAULTS.enableCreatePinFlags,
  },
  /**
   * 创建横幅时的回调
   * 需要返回 `title` 或 `type`
  ...
  createFlagCanThoughDisableDateOrHour: {
    type: Boolean,
    default: CALENDAR_DEFAULTS.createFlagCanThroughDisabledRange,
  },
  /**
   * 横幅内容
   * 一般可设置某些日期范围内的活动标识
  ...
  pinFlags: {
    ...
    default: () => [...CALENDAR_DEFAULTS.pinFlags],
  },
  /**
  ...
  pinFlagsShowTime: {
    type: Boolean,
    default: CALENDAR_DEFAULTS.pinFlagsShowTime,
  },
  /**
   * 是否在两个紧接着的横幅中间留有空隙
  ...
  showSpacingBetweenFlags: {
    type: Boolean,
    default: CALENDAR_DEFAULTS.showSpacingBetweenFlags,
  },
  /**
   * 是否自动填满父容器
  ...
  autoFit: {
    type: Boolean,
    default: CALENDAR_DEFAULTS.autoFit,
  },
  /**
   * 是否显示当前时间的标线
  ...
  currentTimeLine: {
    type: Boolean,
    default: CALENDAR_DEFAULTS.currentTimeLine,
  },
});
