import type { AnchorCommandMap, AnchorListItem } from '@aurora/core';
...
export const useAnchorExposes = {
   ...
   */
  updateActiveLink: Function as ExposeType<AnchorCommandMap['updateActiveLink']>,
  /**
   * 重新获取锚点节点（用于在“自动渲染”模式下重新获取锚点节点）
   * @en Controls refresh anchor list.
   */
  refreshAnchorList: Function as ExposeType<AnchorCommandMap['refreshAnchorList']>,
  /**
   ...
   */
  updateScrollContainer: Function as ExposeType<AnchorCommandMap['updateScrollContainer']>,
  /**
   * 获取锚点列表
