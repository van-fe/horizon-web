...
:::demo vue/components/DatePicker/basic.vue :::
...
:::demo vue/components/DatePicker/multiple.vue :::
...
:::demo vue/components/DatePicker/confirm-type.vue :::

## Clearable

Set `clearable` (enabled by default) to allow users to clear the value with the clear icon.

:::demo vue/components/DatePicker/clearable.vue :::
...
:::demo vue/components/DatePicker/single-trigger.vue :::
...
:::demo vue/components/DatePicker/week.vue :::
...
:::demo vue/components/DatePicker/datetime.vue :::
...
:::demo vue/components/DatePicker/format.vue :::
...
:::demo vue/components/DatePicker/value-format.vue :::

## Hover Preview

Set `hover-to-display-value="true"` to display the hovered date in the input before it is selected.

:::demo vue/components/DatePicker/hover-to-display-value.vue :::
...
:::demo vue/components/DatePicker/disabled-date-and-time.vue :::
