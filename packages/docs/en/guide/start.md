...
- **Style File**
```html
<link rel="stylesheet" href="//unpkg.com/@aurora/horizon-vue/es/styles/index.css" />
```
...
<script src="//unpkg.com/@aurora/horizon-vue/dist/horizon-web-browser.iife.js"></script>
```
```html [UMD]
<!-- Import Vue 3 -->
<script src="//cdn.jsdelivr.net/npm/vue@3"></script>
<!-- Import component library -->
<script src="//unpkg.com/@aurora/horizon-vue/dist/horizon-web-browser.umd.js"></script>
```
:::
...
// import '@aurora/horizon-vue/es/styles/index.scss'; // for scss
