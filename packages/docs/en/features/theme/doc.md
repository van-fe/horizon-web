...
```typescript
import { $themes } from '@aurora/horizon-vue';
```
...
Configurable css variables can refer to [here](https://git.nevint.com/horizon-web/horizon-web/-/tree/master/packages/horizon-vue/src/styles/element)
