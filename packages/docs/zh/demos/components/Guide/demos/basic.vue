<template>
  <n-row>
    <n-col :span="24">
      ...
      <n-button class="guide-second">Second</n-button>
  ...
  <n-guide v-model="current" v-model:visible="visible" type="primary" @close="onClose" @finish="onFinish">
    <n-guide-item :target="firstRef" title="第一步" content="第一步就是第一步" />
    <n-guide-item target=".guide-second" title="第二步" content="第二步就是第二步" placement="top-start" image="https://static.nio.com/fx-static/design-system/clgkp3u9z0002082h1dfr888x/indexbg.jpg?imageView2/2/w/300" />
