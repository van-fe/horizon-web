<template>
  <n-space direction="vertical" block>
    <n-radio-group v-model="mode" class="example">
      <n-radio :label="0">Default</n-radio>
      <n-radio :label="1">Customize Header</n-radio>
      <n-radio :label="2">Customize Title</n-radio>
      <n-radio :label="3">Customize Footer</n-radio>
      <n-radio :label="4">No Title</n-radio>
      <n-radio :label="5">No Header and No Footer</n-radio>
      <n-radio :label="6">Hide Mask</n-radio>
    </n-radio-group>
