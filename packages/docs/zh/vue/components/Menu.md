## 基础使用
:::demo vue/components/Menu/basic.vue :::

## 带标题的一级菜单
如果希望 icon 和 标题内容一起显示，需要设置 `collapse-forever = true`
:::demo vue/components/Menu/shrink.vue :::
...
:::demo vue/components/Menu/horizontal.vue :::

## 拖拽更改菜单宽度
可以设置 `resizable = true` 开启拖拽改变菜单栏宽度的功能

如果不希望在拖拽的过程中折叠菜单，则可以控制 `resize-to-collapse = false` 即可
:::demo vue/components/Menu/resizer.vue :::

## 拦截点选
设置 `before-select`，可以拦截用户点选菜单的操作
:::demo vue/components/Menu/before-select.vue :::
