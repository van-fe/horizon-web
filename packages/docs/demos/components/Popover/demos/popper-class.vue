<template>
  ...
  <div class="test-wrap mb-4">
    <n-popover popper-class="custom-style">
      <template #reference>
        <n-button :plain="true">使用popperClass挂载样式</n-button>
      </template>
      <template #popper>
        <n-pop-content>
          <div class="popper">
  ...
  <div class="test-wrap mb-4">
    <n-popover class="mr-4" popper-class="custom-style2">
      <template #reference>
        <n-button :plain="true">使用popperClass挂载样式</n-button>
      </template>
      <template #popper>
  ...
  <n-button :plain="true" class="mb-4" @click="dialogShow1 = true">在Dialog中使用popover</n-button>
  <n-dialog
    v-model="dialogShow1"
    title="标题"
  ...
  >
    <n-popover class="mr-4">
      <template #reference>
        <n-button :plain="true">不设置toBody</n-button>
      </template>
      <template #popper>
        <n-pop-content>
          <div class="popper">
    ...
    <n-popover class="mr-4" :to-body="false">
      <template #reference>
        <n-button :plain="true">设置toBody为false</n-button>
      </template>
      <template #popper>
        <n-pop-content>
          <div class="popper">
  ...
  <n-button :plain="true" class="mb-4" @click="dialogShow2 = true">在Dialog中使用popover</n-button>
  <n-dialog
    v-model="dialogShow2"
    title="标题"
  ...
  >
    <n-popover class="mr-4">
      <template #reference>
        <n-button :plain="true">不设置z-index</n-button>
      </template>
      <template #popper>
        <n-pop-content>
          <div class="popper">
    ...
    <n-popover class="mr-4" popper-class="custom-style3">
      <template #reference>
        <n-button :plain="true">设置z-index，注意样式如果写在scoped中可能不生效</n-button>
      </template>
      <template #popper>
        <n-pop-content>
          <div class="popper">
