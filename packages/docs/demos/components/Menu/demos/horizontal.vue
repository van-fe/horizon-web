<template>
  <n-row>
    <n-col :span="24">
      <n-form label-position="left" label-vertical-align="middle" label-justify-align="right" :inline="true">
          ...
          >
            ...
            <template #append>
              <n-button v-tooltip="'提醒'" type="normal" :text="true">
                <template #icon>
                  <n-icon name="notice" size="20" :color="theme === 'midnight' ? 'var(--n-text-inverse)' : 'var(--n-text-primary)'"></n-icon>
                </template>
              </n-button>
            ...
            <n-sub-menu value="2">
              ...
              <n-sub-menu value="2-2">
                ...
                <n-menu-item value="2-2-4">三级菜单 4三级菜单 4三级菜单 4三级菜单 4三级菜单 4</n-menu-item>
              </n-sub-menu>
            </n-sub-menu>
            <n-sub-menu value="3" :selectable="true">
              ...
              <n-sub-menu value="3-2">
                <template #title>二级菜单 2</template>
                <n-menu-item value="3-2-1">三级菜单 1三级菜单 1三级菜单 1三级菜单 1三级菜单 1</n-menu-item>
