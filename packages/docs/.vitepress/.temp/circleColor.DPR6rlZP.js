...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "demo-progress" }, _attrs))} data-v-b8e4684b>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Progress/circleColor.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const circleColor = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b8e4684b"]]);
export {
  circleColor as default
};
