          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_h_col, { span: 12 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title" data-v-14e270e4${_scopeId2}>自定义渲染全部节点</div>`);
                  _push3(ssrRenderComponent(_component_h_tree, {
                    ...
                    treeNodeRender: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="tree-item" data-v-14e270e4${_scopeId3}>${ssrInterpolate(data.label)} (${ssrInterpolate(data.value)}) `);
            ...
            _push2(ssrRenderComponent(_component_h_col, { span: 12 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title" data-v-14e270e4${_scopeId2}>自定义渲染指定节点</div>`);
                  _push3(ssrRenderComponent(_component_h_tree, {
                    ...
                    treeNodeRender: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-14e270e4${_scopeId3}>${ssrInterpolate(data.label)} (${ssrInterpolate(data.value)})</div>`);
                      } else {
                        return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Tree/custom-render.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const customRender = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-14e270e4"]]);
export {
