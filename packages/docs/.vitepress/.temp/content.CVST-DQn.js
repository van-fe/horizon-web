...
const _imports_0 = "/demo-assets/scene-city.svg";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "content" }, _attrs))} data-v-aae4558d>`);
      _push(ssrRenderComponent(_component_h_card, { title: "标题" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img class="content-img"${ssrRenderAttr("src", _imports_0)} alt="" data-v-aae4558d${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                class: "content-img",
      ...
      _push(ssrRenderComponent(_component_h_card, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<ul class="list" data-v-aae4558d${_scopeId}><!--[-->`);
            ssrRenderList(3, (item) => {
              _push2(`<li data-v-aae4558d${_scopeId}><h4 data-v-aae4558d${_scopeId}>标题</h4><p data-v-aae4558d${_scopeId}> 卡片内容区域可以是文字、图片、表单、表格等形式信息内容。可使用大中小不同的卡片尺寸，按业务需求进行呈现。 </p></li>`);
            });
            _push2(`<!--]--></ul>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_h_card, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-aae4558d${_scopeId}> 这是一段很长很长很长很长很长很长很长很长很长很长很长很长很长很长很的内容文案这是一段很长很长很长很长很长很长很长很长很长很长很长很长很长很长很的内容文案这是一段很长很长很长很长很长很长很长很长很长很长很长很长很长很长很的内容文案这是一段长很长很长很长很长很长很的内容文案 </p>`);
          } else {
            return [
...
const content = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-aae4558d"]]);
export {
  content as default
};
