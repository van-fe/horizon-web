...
`,
  ...
  _push(`<h2 id="close-and-add" tabindex="-1">Close and Add <a class="header-anchor" href="#close-and-add" aria-label="Permalink to &quot;Close and Add&quot;">​</a></h2><p>By setting <code>h-tabs (editable)</code>, <code>h-tab (closable)</code> attributes, you can enable dynamic addition and deletion of tabs. Only effective in <code>line | card | page</code>; the logic of closing and adding is implemented by the business. <code>v2 = true</code>, if the deleted tab is the current tab, the first tab is selected by default</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<script setup lang="ts">
import { $message, type HTabValue } from '@aurora/horizon-web';
...
`,
  ...
  _push(`<h2 id="use-with-h-panel" tabindex="-1">Use with <code>h-panel</code> <a class="header-anchor" href="#use-with-h-panel" aria-label="Permalink to &quot;Use with \`h-panel\`&quot;">​</a></h2><p>Use panel component to develop tab applications</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
...
`,
  ...
  _push(`</td><td>Configuration for model value.</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">active-key</td><td>Configuration for active key.</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">v2</td><td>Configuration for v2.</td><td><code>boolean</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">default-active-key</td><td>Configuration for default active key.</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">size</td><td>Configuration for size.</td><td><code>&#39;small&#39; | &#39;medium&#39; | &#39;large&#39; | &#39;huge&#39;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">draggable</td><td>Configuration for draggable.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">scrollable</td><td>Configuration for scrollable.</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">focusable</td><td>Configuration for focusable.</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">arrow</td><td>Configuration for arrow.</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">type</td><td>Configuration for type.</td><td><code>&#39;line&#39; | &#39;card&#39; | Segment | &#39;page&#39;</code></td><td class="text-center">No</td><td>&#39;line&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">show-underline`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "<code>underline</code>" }, null, _parent));
  _push(`</td><td>Configuration for show underline.</td><td><code>boolean</code></td><td class="text-center">No</td><td>undefined</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">underline</td><td>Configuration for underline.</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">indicator</td><td>Configuration for indicator.</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">show-add`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "<code>editable</code>" }, null, _parent));
  _push(`</td><td>Configuration for show add.</td><td><code>boolean</code></td><td class="text-center">No</td><td>undefined</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">editable</td><td>Configuration for editable.</td><td><code>boolean</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">before-change</td><td>Configuration for before change.</td><td><code>(key: HTabValue, change?: () =&gt; void) =&gt; PromiseLike&lt;boolean&gt;</code></td><td class="text-center">No</td><td></td></tr></tbody></table><h3 id="tabs-emits" class="no-underline h3"><a href="#tabs-emits" class="!no-underline">Tabs Emits</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">update:active-key</td><td rowspan="1">Emitted when update:active key changes.</td><td rowspan="1">( key: <code>HTabValue</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">key</td><td><code>HTabValue</code></td><td></td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">change</td><td rowspan="1">Emitted when change changes.</td><td rowspan="1">( key: <code>HTabValue</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">key</td><td><code>HTabValue</code></td><td></td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">add</td><td rowspan="1">Emitted when add changes.</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">close</td><td rowspan="1">Emitted when close changes.</td><td rowspan="1">( key: <code>HTabValue</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">key</td><td><code>HTabValue</code></td><td></td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">blur`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "" }, null, _parent));
  _push(`</td><td rowspan="1">Emitted when blur changes.</td><td rowspan="1">( evt: <code>FocusEvent</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">evt</td><td><code>FocusEvent</code></td><td>The evt value.</td></tr><tr><td rowspan="3" style="${ssrRenderStyle({ "word-break": "keep-all" })}">sort</td><td rowspan="3">Emitted when sort changes.</td><td rowspan="3">( current: <code>number</code>, target: <code>number</code>, keys: <code>HTabValue[]</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">current</td><td><code>number</code></td><td>当前拖拽的索引</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">target</td><td><code>number</code></td><td>目标索引</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">keys</td><td><code>HTabValue[]</code></td><td>The keys value.</td></tr></tbody></table><h2 id="tab-api" class="no-underline h2"><a href="#tab-api" class="!no-underline">Tab Api</a></h2><h3 id="tab-props" class="no-underline h3"><a href="#tab-props" class="!no-underline">Tab Props</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">name`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "<code>key</code>" }, null, _parent));
  _push(`</td><td>Configuration for name.</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">label</td><td>Configuration for label.</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">icon</td><td>Configuration for icon.</td><td><code>string</code></td><td class="text-center">No</td><td>&#39;&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">icon-size</td><td>Configuration for icon size.</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">disabled</td><td>Configuration for disabled.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">show-close`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "<code>closable</code>" }, null, _parent));
  _push(`</td><td>Configuration for show close.</td><td><code>boolean</code></td><td class="text-center">No</td><td>undefined</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">closable</td><td>Configuration for closable.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">draggable</td><td>Configuration for draggable.</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">min-width`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "请直接设置 <code>HTab.style</code> 来控制宽度d" }, null, _parent));
  _push(`</td><td>Configuration for min width.</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">max-width`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "请直接设置 <code>HTab.style</code> 来控制宽度" }, null, _parent));
  _push(`</td><td>Configuration for max width.</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr></tbody></table><h3 id="tab-emits" class="no-underline h3"><a href="#tab-emits" class="!no-underline">Tab Emits</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">click</td><td rowspan="1">Emitted when click changes.</td><td rowspan="1">( key: <code>HTabValue</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">key</td><td><code>HTabValue</code></td><td></td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">close</td><td rowspan="1">Emitted when close changes.</td><td rowspan="1">( key: <code>HTabValue</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">key</td><td><code>HTabValue</code></td><td></td></tr></tbody></table></div>`);
}
