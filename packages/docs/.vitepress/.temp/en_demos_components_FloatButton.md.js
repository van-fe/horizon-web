...
`,
  ...
  _push(`<h2 id="button-group" tabindex="-1">Button Group <a class="header-anchor" href="#button-group" aria-label="Permalink to &quot;Button Group&quot;">​</a></h2><p>Use <code>h-float-button-group</code> to enable button group</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <div>
    <h-form label-position="left" label-vertical-align="middle" label-width="150px" helper-placement="after-label" helper-theme="dark" style="width: 400px">
...
`,
  ...
  _push(`<h2 id="floatbutton-api" class="no-underline h2"><a href="#floatbutton-api" class="!no-underline">FloatButton Api</a></h2><h3 id="floatbutton-props" class="no-underline h3"><a href="#floatbutton-props" class="!no-underline">FloatButton Props</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">icon</td><td>Configuration for icon.</td><td><code>iconPropType</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">description</td><td>Configuration for description.</td><td><code>string | VNode</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">tooltip</td><td>Configuration for tooltip.</td><td><code>string | Partial&lt;TooltipProps&gt;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">type</td><td>Configuration for type.</td><td><code>&#39;primary&#39; | &#39;normal&#39;</code></td><td class="text-center">No</td><td>&#39;normal&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">shape</td><td>Configuration for shape.</td><td><code>&#39;circle&#39; | &#39;square&#39;</code></td><td class="text-center">No</td><td>&#39;circle&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">href</td><td>Configuration for href.</td><td><code>string</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">target</td><td>Configuration for target.</td><td><code>&#39;_blank&#39; | &#39;_self&#39; | &#39;_parent&#39; | &#39;_top&#39;</code></td><td class="text-center">No</td><td>&#39;_self&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">badge</td><td>Configuration for badge.</td><td><code>boolean | Partial&lt;BadgeProps&gt;</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">draggable</td><td>Configuration for draggable.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">adsorb-bottom</td><td>Configuration for adsorb bottom.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">visible</td><td>Configuration for visible.</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr></tbody></table><h3 id="floatbutton-emits" class="no-underline h3"><a href="#floatbutton-emits" class="!no-underline">FloatButton Emits</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">click</td><td rowspan="1">Emitted when click changes.</td><td rowspan="1">( evt: <code>MouseEvent</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">evt</td><td><code>MouseEvent</code></td><td>The evt value.</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">drag-start</td><td rowspan="1">Emitted when drag start changes.</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">dragging</td><td rowspan="1">Emitted when dragging changes.</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">drag-end</td><td rowspan="1">Emitted when drag end changes.</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr></tbody></table><h2 id="floatbuttongroup-api" class="no-underline h2"><a href="#floatbuttongroup-api" class="!no-underline">FloatButtonGroup Api</a></h2><h3 id="floatbuttongroup-props" class="no-underline h3"><a href="#floatbuttongroup-props" class="!no-underline">FloatButtonGroup Props</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">type</td><td>Configuration for type.</td><td><code>&#39;primary&#39; | &#39;normal&#39;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">shape</td><td>Configuration for shape.</td><td><code>&#39;circle&#39; | &#39;square&#39;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">use-collapse</td><td>Configuration for use collapse.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">trigger</td><td>Configuration for trigger.</td><td><code>&#39;click&#39; | &#39;hover&#39;</code></td><td class="text-center">No</td><td>&#39;click&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">expand-icon</td><td>Configuration for expand icon.</td><td><code>iconPropType</code></td><td class="text-center">No</td><td>() =&gt; IconMoreTwo</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">fold-icon</td><td>Configuration for fold icon.</td><td><code>iconPropType</code></td><td class="text-center">No</td><td>() =&gt; IconClose</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">expand-tooltip</td><td>Configuration for expand tooltip.</td><td><code>string | Partial&lt;TooltipProps&gt;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">fold-tooltip</td><td>Configuration for fold tooltip.</td><td><code>string | Partial&lt;TooltipProps&gt;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">badge</td><td>Configuration for badge.</td><td><code>Partial&lt;BadgeProps&gt;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">draggable</td><td>Configuration for draggable.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">adsorb-bottom</td><td>Configuration for adsorb bottom.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">visible</td><td>Configuration for visible.</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr></tbody></table><h3 id="floatbuttongroup-emits" class="no-underline h3"><a href="#floatbuttongroup-emits" class="!no-underline">FloatButtonGroup Emits</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">expand</td><td rowspan="1">Emitted when expand changes.</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">fold</td><td rowspan="1">Emitted when fold changes.</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">click</td><td rowspan="1">Emitted when click changes.</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr></tbody></table></div>`);
}
