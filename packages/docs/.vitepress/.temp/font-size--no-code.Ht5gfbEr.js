...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "colors" }, _attrs))} data-v-61b2cac6>`);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    ssrRenderList(group, (token) => {
                      _push3(`<div class="color" data-v-61b2cac6${_scopeId2}><div class="label" data-v-61b2cac6${_scopeId2}><div class="key" data-v-61b2cac6${_scopeId2}>${ssrInterpolate(token.refToken)} `);
                      _push3(ssrRenderComponent(_component_copy_btn, {
                        text: token.refToken
                      }, null, _parent3, _scopeId2));
                      _push3(`</div></div><div class="value" data-v-61b2cac6${_scopeId2}>${ssrInterpolate(token.value)}</div></div>`);
                    });
                    _push3(`<!--]-->`);
                  } else {
                    return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("en/features/tokens/demos/font-size--no-code.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const fontSize_NoCode = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-61b2cac6"]]);
export {
