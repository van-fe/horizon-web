...
`,
  ...
  _push(`<h2 id="backtop-api" class="no-underline h2"><a href="#backtop-api" class="!no-underline">Backtop Api</a></h2><h3 id="backtop-props" class="no-underline h3"><a href="#backtop-props" class="!no-underline">Backtop Props</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">visibility-height</td><td>Configuration for visibility height.</td><td><code>number</code></td><td class="text-center">No</td><td>400</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">bottom</td><td>Configuration for bottom.</td><td><code>number</code></td><td class="text-center">No</td><td>120</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">right</td><td>Configuration for right.</td><td><code>number</code></td><td class="text-center">No</td><td>24</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">target</td><td>Configuration for target.</td><td><code>string</code></td><td class="text-center">No</td><td></td></tr></tbody></table><h3 id="backtop-emits" class="no-underline h3"><a href="#backtop-emits" class="!no-underline">Backtop Emits</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">click</td><td rowspan="1">Emitted when click changes.</td><td rowspan="1">( event: <code>MouseEvent</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">event</td><td><code>MouseEvent</code></td><td>The event value.</td></tr></tbody></table></div>`);
}
