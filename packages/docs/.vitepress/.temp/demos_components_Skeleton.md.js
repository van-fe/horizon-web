...
`,
  ...
  _push(`<h2>Skeleton Api</h2><h3>Skeleton Props</h3><table class="md-table"><thead><tr><th>属性</th><th>说明</th><th>类型</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">必填</th><th>默认值</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">loading</td><td>骨架屏是否显示</td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">animated</td><td>骨架屏是否以动画形式显示</td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr></tbody></table><h2>SkeletonItem Api</h2><h3>SkeletonItem Props</h3><table class="md-table"><thead><tr><th>属性</th><th>说明</th><th>类型</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">必填</th><th>默认值</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">shape</td><td>原子骨架屏形状</td><td><code>&#39;avatar&#39; | &#39;text&#39; | &#39;operate&#39; | &#39;image&#39; | &#39;picture&#39;</code></td><td class="text-center">是</td><td>&#39;text&#39;</td></tr></tbody></table></div>`);
}
