...
`,
  ...
  _push(`<h2 id="异步加载" tabindex="-1">异步加载 <a class="header-anchor" href="#异步加载" aria-label="Permalink to &quot;异步加载&quot;">​</a></h2><p>因为 <code>steps</code> 组件是在 <code>h-step</code> 挂载时才会确定每个步骤的下标，所以如果存在前后步骤固定，但中间步骤是异步加载的，会导致最终顺序不正确</p><p>因此需要给 <code>h-step</code> 设置 <code>index</code>，确保顺序是符合预期的</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-row :gutter="10">
    <h-col :span="24">
