...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "colors" }, _attrs))} data-v-65267fa7><!--[-->`);
      ssrRenderList(unref(elementListTokens).transition, (token) => {
        _push(`<div class="color" data-v-65267fa7><div class="label" data-v-65267fa7><div class="key" data-v-65267fa7>${ssrInterpolate(token.refToken)} `);
        _push(ssrRenderComponent(_component_copy_btn, {
          text: token.refToken
        }, null, _parent));
        _push(`</div></div><div class="value" data-v-65267fa7>${ssrInterpolate(token.value)}</div></div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const transition_NoCode = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-65267fa7"]]);
export {
