...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid" }, _attrs))} data-v-67729b60><div data-v-67729b60>`);
  _push(ssrRenderComponent(_component_h_button, { disabled: true }, {
  ...
  _push(`</div><div class="dark" data-v-67729b60>`);
  _push(ssrRenderComponent(_component_h_button, {
    plain: true,
    disabled: true,
    ghost: ""
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Primary Plain Ghost Button`);
      } else {
        return [
          createTextVNode("Primary Plain Ghost Button")
        ];
      }
    }),
    _: 1
  ...
  _push(ssrRenderComponent(_component_h_button, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Danger Plain Ghost Button`);
      } else {
        return [
          createTextVNode("Danger Plain Ghost Button")
        ];
      }
    }),
    _: 1
  ...
  _push(ssrRenderComponent(_component_h_button, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Normal Plain Ghost Button`);
      } else {
        return [
          createTextVNode("Normal Plain Ghost Button")
        ];
      }
    }),
    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Button/disabled.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const disabled = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-67729b60"]]);
export {
  disabled as default
};
