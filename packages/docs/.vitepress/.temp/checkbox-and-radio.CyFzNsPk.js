    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_h_form, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_h_form_item, { label: "单选显示单选框" }, {
            ...
            _push2(ssrRenderComponent(_component_h_form_item, { label: "多选显示多选框" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_h_switch, {
                    modelValue: showCheckbox.value,
                    "onUpdate:modelValue": ($event) => showCheckbox.value = $event,
                    status: true
                  }, null, _parent3, _scopeId2));
                } else {
                  return [
            ...
            return [
              createVNode(_component_h_form_item, { label: "单选显示单选框" }, {
                default: withCtx(() => [
                  createVNode(_component_h_switch, {
                    modelValue: showRadio.value,
                    "onUpdate:modelValue": ($event) => showRadio.value = $event,
              ...
              createVNode(_component_h_form_item, { label: "多选显示多选框" }, {
                default: withCtx(() => [
                  createVNode(_component_h_switch, {
                    modelValue: showCheckbox.value,
                    "onUpdate:modelValue": ($event) => showCheckbox.value = $event,
            ...
            _push2(ssrRenderComponent(_component_h_col, { span: 12 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_h_tree, {
                    "tree-data": baseTreeData.value,
                    "show-checkbox": showCheckbox.value,
                    multiple: true
                  }, null, _parent3, _scopeId2));
                } else {
                  return [
                    ...
                    createVNode(_component_h_tree, {
                      ...
                      "show-checkbox": showCheckbox.value,
                      multiple: true
                    }, null, 8, ["tree-data", "show-checkbox"])
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Tree/checkbox-and-radio.vue");
