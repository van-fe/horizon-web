...
`,
  ...
  _push(`<h2 id="badge-api" class="no-underline h2"><a href="#badge-api" class="!no-underline">Badge Api</a></h2><h3 id="badge-props" class="no-underline h3"><a href="#badge-props" class="!no-underline">Badge Props</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">type</td><td>Configuration for type.</td><td><code>&#39;dot&#39; | &#39;num&#39; | &#39;icon&#39;</code></td><td class="text-center">No</td><td>&#39;dot&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">content</td><td>Configuration for content.</td><td><code>string | number</code></td><td class="text-center">No</td><td>&#39;&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">hidden</td><td>Configuration for hidden.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">num-max</td><td>Configuration for num max.</td><td><code>number</code></td><td class="text-center">No</td><td>Infinity</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">color</td><td>Configuration for color.</td><td><code>string</code></td><td class="text-center">No</td><td>cssVariable(&#39;bg-error-default&#39;)</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">icon-size</td><td>Configuration for icon size.</td><td><code>number</code></td><td class="text-center">No</td><td>16</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">icon-color</td><td>Configuration for icon color.</td><td><code>string</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">bottom</td><td>Configuration for bottom.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">align</td><td>Configuration for align.</td><td><code>&#39;center-point&#39; | &#39;inner&#39; | &#39;outer&#39; | &#39;fix-left&#39;</code></td><td class="text-center">No</td><td>&#39;center-point&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">offset</td><td>Configuration for offset.</td><td><code>Offset</code></td><td class="text-center">No</td><td>null</td></tr></tbody></table></div>`);
}
