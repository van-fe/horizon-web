...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const selectOptionsHasDisabled = [
    ...
    const selectOptionGroupsHasDisabled = [
      {
        disabled: true,
        children: [
          { value: 1, label: "上海", disabled: true },
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_h_col, { span: 6 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title"${_scopeId2}> 单选: 整体禁用 </div>`);
                  ...
                  return [
                    createVNode("div", { class: "demo-title" }, " 单选: 整体禁用 "),
            ...
            _push2(ssrRenderComponent(_component_h_col, { span: 6 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title"${_scopeId2}> 单选: 选项禁用 </div>`);
                  _push3(ssrRenderComponent(_component_h_select, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<!--[-->`);
                        ssrRenderList(selectOptionsHasDisabled, (item) => {
                          _push4(ssrRenderComponent(_component_h_option, {
                            key: item.value,
                            label: item.label,
                            value: item.value,
                        ...
                        return [
                          (openBlock(), createBlock(Fragment, null, renderList(selectOptionsHasDisabled, (item) => {
                            return createVNode(_component_h_option, {
                              key: item.value,
                              label: item.label,
                              value: item.value,
                  ...
                  return [
                    createVNode("div", { class: "demo-title" }, " 单选: 选项禁用 "),
                    createVNode(_component_h_select, {
                      modelValue: value2.value,
                      "onUpdate:modelValue": ($event) => value2.value = $event,
                      clearable: true,
            ...
            _push2(ssrRenderComponent(_component_h_col, { span: 6 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title"${_scopeId2}> 单选: 选项组禁用 </div>`);
                  _push3(ssrRenderComponent(_component_h_select, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<!--[-->`);
                        ssrRenderList(selectOptionGroupsHasDisabled, (group, index) => {
                        ...
                        return [
                          (openBlock(), createBlock(Fragment, null, renderList(selectOptionGroupsHasDisabled, (group, index) => {
                  ...
                  return [
                    createVNode("div", { class: "demo-title" }, " 单选: 选项组禁用 "),
                    createVNode(_component_h_select, {
                      modelValue: value3.value,
                      "onUpdate:modelValue": ($event) => value3.value = $event,
                      clearable: true,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_h_col, { span: 6 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title"${_scopeId2}> 多选: 整体禁用 </div>`);
                  _push3(ssrRenderComponent(_component_h_select, {
                  ...
                  return [
                    createVNode("div", { class: "demo-title" }, " 多选: 整体禁用 "),
                    createVNode(_component_h_select, {
                      modelValue: values1.value,
                      "onUpdate:modelValue": ($event) => values1.value = $event,
                      multiple: true,
            ...
            _push2(ssrRenderComponent(_component_h_col, { span: 6 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title"${_scopeId2}> 多选: 选项禁用 </div>`);
                  _push3(ssrRenderComponent(_component_h_select, {
                  ...
                  return [
                    createVNode("div", { class: "demo-title" }, " 多选: 选项禁用 "),
                    createVNode(_component_h_select, {
                      modelValue: values2.value,
                      "onUpdate:modelValue": ($event) => values2.value = $event,
                      multiple: true,
            ...
            _push2(ssrRenderComponent(_component_h_col, { span: 6 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title"${_scopeId2}> 多选: 选项组禁用 </div>`);
                  _push3(ssrRenderComponent(_component_h_select, {
                  ...
                  return [
                    createVNode("div", { class: "demo-title" }, " 多选: 选项组禁用 "),
                    createVNode(_component_h_select, {
                      modelValue: values3.value,
                      "onUpdate:modelValue": ($event) => values3.value = $event,
                      multiple: true,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Select/disabled.vue");
