      ...
      _push(ssrRenderComponent(_component_h_form, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_h_form_item, { label: "是否强调" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_h_switch, {
                    modelValue: stress.value,
                    "onUpdate:modelValue": ($event) => stress.value = $event,
                    status: true,
                    "status-off-text": "否",
                    "status-on-text": "是"
                  }, null, _parent3, _scopeId2));
            ...
            return [
              ...
              createVNode(_component_h_form_item, { label: "是否强调" }, {
                default: withCtx(() => [
                  createVNode(_component_h_switch, {
                    modelValue: stress.value,
                    "onUpdate:modelValue": ($event) => stress.value = $event,
                ...
                if (_push3) {
                  ...
                  return [
                    ...
                    createVNode(_component_h_tree, {
                      ...
                      "parent-effect-disabled-child": parentEffectDisabledChild.value,
                      stress: stress.value
                    }, null, 8, ["tree-data", "disabled", "check-strictly", "parent-effect-disabled-child", "stress"])
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Tree/disabled.vue");
