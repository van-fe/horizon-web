        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_h_col, { span: 24 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="color-palettes" data-v-8b6c4728${_scopeId2}><!--[-->`);
                  ssrRenderList(color.value, (item, index) => {
                    _push3(`<div class="color-item" style="${ssrRenderStyle({ background: item, color: textColor(item) })}" data-v-8b6c4728${_scopeId2}>${ssrInterpolate(item.toUpperCase())}</div>`);
                  });
                  _push3(`<!--]--></div>`);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("en/style-animation/colors/demos/generator.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const generator = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8b6c4728"]]);
export {
