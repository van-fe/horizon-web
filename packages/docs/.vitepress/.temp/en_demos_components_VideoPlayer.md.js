...
`,
  ...
  _push(`<h2 id="videoplayer-api" class="no-underline h2"><a href="#videoplayer-api" class="!no-underline">VideoPlayer Api</a></h2><h3 id="videoplayer-props" class="no-underline h3"><a href="#videoplayer-props" class="!no-underline">VideoPlayer Props</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">sources</td><td>Configuration for sources.</td><td><code>Source[]</code></td><td class="text-center">Yes</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">poster</td><td>Configuration for poster.</td><td><code>string</code></td><td class="text-center">No</td><td>&#39;&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">rotate</td><td>Configuration for rotate.</td><td><code>0 | 90 | 180 | 270</code></td><td class="text-center">No</td><td>0</td></tr></tbody></table><h3 id="videoplayer-emits" class="no-underline h3"><a href="#videoplayer-emits" class="!no-underline">VideoPlayer Emits</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">ready</td><td rowspan="1">Emitted when ready changes.</td><td rowspan="1">( playerInstance: <code>HTMLVideoElement</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">playerInstance</td><td><code>HTMLVideoElement</code></td><td>The player instance value.</td></tr></tbody></table></div>`);
}
