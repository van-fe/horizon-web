...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "tree-multiple-selection",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Table/tree-multiple-selection.vue");
