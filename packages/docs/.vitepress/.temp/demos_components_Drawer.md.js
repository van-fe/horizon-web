...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"demos/components/Drawer.md","filePath":"zh/demos/components/Drawer.md"}');
const _sfc_main = { name: "demos/components/Drawer.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_demo_block = resolveComponent("demo-block");
  const _component_deprecated_tips = resolveComponent("deprecated-tips");
  _push(`<div${ssrRenderAttrs(_attrs)}><h1>Drawer</h1><p class="description">触发命令后，从屏幕一侧滑出的抽屉式的面板。</p><h2 id="基本用法" tabindex="-1">基本用法 <a class="header-anchor" href="#基本用法" aria-label="Permalink to &quot;基本用法&quot;">​</a></h2><p>抽屉支持从屏幕的任意一侧滑出，默认位置是从右边，默认尺寸 <code>medium</code>。</p>`);
...
`,
  ...
  _push(`<h2 id="抽屉位置" tabindex="-1">抽屉位置 <a class="header-anchor" href="#抽屉位置" aria-label="Permalink to &quot;抽屉位置&quot;">​</a></h2><p>自定义位置，点击触发按钮抽屉从相应的位置滑出。</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
...
`,
  ...
  _push(`<h2 id="抽屉尺寸" tabindex="-1">抽屉尺寸 <a class="header-anchor" href="#抽屉尺寸" aria-label="Permalink to &quot;抽屉尺寸&quot;">​</a></h2><p>通过 <code>size</code> 可以自由控制抽屉的尺寸，支持预定义的枚举: <code>small</code>/<code>medium</code>/<code>large</code>，也支持类似数字百分比，如 <code>300</code>, <code>500px</code>, <code>75%</code>。</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
...
`,
  ...
  _push(`<h2 id="自定义节点" tabindex="-1">自定义节点 <a class="header-anchor" href="#自定义节点" aria-label="Permalink to &quot;自定义节点&quot;">​</a></h2><p>你可以设置模块是否显示或通过插槽完全自定义底部。请注意这里设置 <code>v2</code> 采用新版本逻辑</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
...
`,
  ...
  _push(`<h2 id="嵌套抽屉" tabindex="-1">嵌套抽屉 <a class="header-anchor" href="#嵌套抽屉" aria-label="Permalink to &quot;嵌套抽屉&quot;">​</a></h2><p>在抽屉内打开新的抽屉</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-button @click="visible = true">Open Drawer</h-button>
...
`,
  ...
  _push(`<h2 id="关闭确认" tabindex="-1">关闭确认 <a class="header-anchor" href="#关闭确认" aria-label="Permalink to &quot;关闭确认&quot;">​</a></h2><p>在抽屉关闭时候，返回 <code>Promise&lt;false&gt;</code> 来阻止关闭抽屉</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-button @click="visible = true">Open Drawer</h-button>
  <h-drawer
...
`,
  ...
  _push(`<h2 id="挂载位置" tabindex="-1">挂载位置 <a class="header-anchor" href="#挂载位置" aria-label="Permalink to &quot;挂载位置&quot;">​</a></h2><p>通过 <code>to</code> 可以设置弹出层节点的挂载位置</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
...
`,
  ...
  _push(`<h2 id="v1-x-兼容性逻辑" tabindex="-1">v1.x 兼容性逻辑 <a class="header-anchor" href="#v1-x-兼容性逻辑" aria-label="Permalink to &quot;v1.x 兼容性逻辑&quot;">​</a></h2><p>为了业务更顺滑迁移，针对 <code>v1.x</code> 版本做了部分兼容，通过 <code>v2</code> 可以设置使用 <code>v2.x</code> 逻辑。<br> 1.抽屉顶部展示逻辑。默认采用 <code>v1.x</code> 逻辑，<code>title</code> 或者 <code>slot.title</code> 设置为 <code>Falsy</code>，抽屉不展示顶部内容<br> 2.抽屉底部展示逻辑。默认采用 <code>v1.x</code> 逻辑，<code>slot.footer</code> 或者 <code>primaryButton(deprecated) | secondaryButton(deprecated)</code> 为 <code>Falsy</code>，不展示底部的值。<br> 3.抽屉teleport逻辑。默认采用<code>v1.x</code>，设置 <code>toBody=false</code>，则直接渲染抽屉到特定的位置，开启 <code>v2</code> 后，则根据 <code>to</code> 判断</p><p>当 <code>v2=true</code> 时候，抽屉顶部和底部逻辑分别被 <code>header</code> 和 <code>footer</code> 控制。</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <div class="example">
...
<span class="line"></span>
<span class="line"><span style="${ssrRenderStyle({ "--shiki-light": "#6A737D", "--shiki-dark": "#6A737D" })}">  // @deprecated: NOTE: 下个版本移除，本版本生效</span></span>
...
<span class="line"><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br></div></div><h2>Drawer Api</h2><h3>Drawer Props</h3><table class="md-table"><thead><tr><th>属性</th><th>说明</th><th>类型</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">必填</th><th>默认值</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">v-model`);
  ...
  _push(`</td><td>抽屉状态</td><td><code>boolean</code></td><td class="text-center">否</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">visible</td><td>抽屉的展示状态(v-model:visible)</td><td><code>boolean</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">v2</td><td>使用 <code>v2.x.x</code> 抽屉的设计逻辑<br>影响: slots.title 和 slots.header 处理逻辑<br>- v2 = false: slots.title 会被整体渲染到抽屉头部<br>- v2 = true: slots.title 会被渲染到 slots.header 中，有层次关系<br>请注意：如果设置 <code>v2=false</code>，同时设置新增属性header、footer、以及新增slots.header，依旧会按照新版本的逻辑处理</td><td><code>boolean</code></td><td class="text-center">否</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">position`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "<code>placement</code>" }, null, _parent));
  _push(`</td><td>抽屉位置</td><td><code>&#39;left&#39; | &#39;right&#39; | &#39;top&#39; | &#39;bottom&#39;</code></td><td class="text-center">否</td><td>&#39;right&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">placement</td><td>抽屉位置</td><td><code>&#39;left&#39; | &#39;right&#39; | &#39;top&#39; | &#39;bottom&#39;</code></td><td class="text-center">否</td><td>&#39;right&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">title</td><td>抽屉标题</td><td><code>string</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">size</td><td>抽屉尺寸，如果是数值会自动加上 <code>px</code>，也可以是字符串如 <code>40%</code></td><td><code>&#39;small&#39; | &#39;medium&#39; | &#39;large&#39; | string | number</code></td><td class="text-center">否</td><td>&#39;medium&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">mask</td><td>是否显示蒙层</td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">mask-close`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "<code>maskClosable</code>" }, null, _parent));
  _push(`</td><td>点击蒙层是否关闭抽屉</td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">mask-closable</td><td>点击蒙层是否关闭抽屉，使用 <code>maskClosable</code> 替代</td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">esc-close`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "，使用 <code>escClosable</code> 替代" }, null, _parent));
  _push(`</td><td>按下 ESC 键是否关闭抽屉</td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">esc-closable</td><td>按下 ESC 键是否关闭抽屉</td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">close-button`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "<code>closable</code>" }, null, _parent));
  _push(`</td><td>是否显示右上角关闭按钮，只有设置了 <code>header=true</code> 才会生效</td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">closable</td><td>是否显示右上角关闭按钮</td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">footer</td><td>是否展示底部内容，当 <code>v2=true</code> 设置时候，忽略其他条件，仅判断 <code>footer</code></td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">header</td><td>是否展示头部内容，当 <code>v2=true</code> 设置时候，忽略其他条件，仅判断 <code>footer</code></td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">primary-button`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "<code>okButton</code>" }, null, _parent));
  _push(`</td><td>是否显示主要按钮</td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">ok-button</td><td>是否显示主要按钮</td><td><code>boolean | ButtonProps</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">primary-text`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "<code>okButtonText</code>" }, null, _parent));
  _push(`</td><td>主要按钮的文本</td><td><code>string</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">ok-button-text</td><td>主要按钮的文本</td><td><code>string</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">secondary-button`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "<code>cancelButton</code>" }, null, _parent));
  _push(`</td><td>是否显示次要按钮</td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">cancel-button</td><td>是否显示次要按钮</td><td><code>boolean | ButtonProps</code></td><td class="text-center">否</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">secondary-text`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "<code>cancelButtonText</code>" }, null, _parent));
  _push(`</td><td>次要按钮的文本</td><td><code>string</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">cancel-button-text</td><td>次要按钮的文本</td><td><code>string</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">before-close</td><td>关闭之前的回调，返回false 或者 Promise.resolve(false) 会停止关闭抽屉。<br>传入close方法已过时，下个版本移除<br>PS：请注意默认close动作，都会在 beforeClose 后执行，等待 beforeClose 执行完成后触发</td><td><code>(close?: () =&gt; void) =&gt; void | boolean | PromiseLike&lt;boolean | void&gt;</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">to-body`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "<code>to</code>" }, null, _parent));
  _push(`</td><td>是否将 <code>drawer</code> 挂载在 <code>body</code> 上</td><td><code>boolean</code></td><td class="text-center">否</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">to</td><td>弹出框的挂载容器，和 <code>&lt;teleport&gt;</code> 保持一致，启用请使用启用 <code>v2</code> 属性</td><td><code>string | TeleportProps[&#39;to&#39;] | HTMLElement</code></td><td class="text-center">否</td><td>&#39;body&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">lock-scroll</td><td>是否在 <code>Drawer</code> 出现时将 <code>body</code> 滚动锁定<br>如果没有设置，则在 <code>mask = true</code> 时自动开启</td><td><code>boolean</code></td><td class="text-center">否</td><td>undefined</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">size-draggable</td><td>启用则可以使用鼠标拖拽抽屉尺寸</td><td><code>boolean</code></td><td class="text-center">否</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">push`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "不推荐使用" }, null, _parent));
  _push(`</td><td>启用抽屉推动行为，当启用时保持多个抽屉位置不变（**不推荐使用**）</td><td><code>boolean</code></td><td class="text-center">否</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">loading</td><td></td><td><code>boolean</code></td><td class="text-center">否</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">destroy-on-close</td><td>关闭后是否销毁抽屉</td><td><code>boolean</code></td><td class="text-center">否</td><td>true</td></tr></tbody></table><h3>Drawer Emits</h3><table class="md-table"><thead><tr><th>属性</th><th>说明</th><th>类型</th><th>参数名</th><th>参数类型</th><th>参数说明</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">update:visible</td><td rowspan="1">更新 visible</td><td rowspan="1">( value: <code>false</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">value</td><td><code>false</code></td><td></td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">primary-click`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("zh/demos/components/Drawer.md");
