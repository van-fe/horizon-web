...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "recycle-scroller-demo" }, _attrs))} data-v-b6eaf389><section data-v-b6eaf389>`);
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_h_col, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` (${ssrInterpolate(_ctx.updateParts.viewStartIdx)} - [${ssrInterpolate(_ctx.updateParts.visibleStartIdx)} - ${ssrInterpolate(_ctx.updateParts.visibleEndIdx)}] - ${ssrInterpolate(_ctx.updateParts.viewEndIdx)}) <br data-v-b6eaf389${_scopeId2}> (元素索引开始于 - [可见元素开始于 - 可见元素结束于] - 元素索引结束于) `);
            } else {
              return [
    ...
    default: withCtx((props, _push2, _parent2, _scopeId) => {
      if (_push2) {
        if (props.item.type === "letter") {
          _push2(`<div class="tr letter big" data-v-b6eaf389${_scopeId}><div class="td index" data-v-b6eaf389${_scopeId}>${ssrInterpolate(props.index)}</div><div class="td value" data-v-b6eaf389${_scopeId}>${ssrInterpolate(props.item.value.name)} Scoped</div></div>`);
        } else {
          _push2(`<div class="tr person" data-v-b6eaf389${_scopeId}><div class="td index" data-v-b6eaf389${_scopeId}>${ssrInterpolate(props.index)}</div><div class="td" data-v-b6eaf389${_scopeId}><div class="info" data-v-b6eaf389${_scopeId}><div class="avatar" data-v-b6eaf389${_scopeId}>`);
          if (props.item.value.avatar) {
            _push2(`<img${ssrRenderAttr("src", props.item.value.avatar)} alt="" data-v-b6eaf389${_scopeId}>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div><span data-v-b6eaf389${_scopeId}>${ssrInterpolate(props.item.value.name)}</span></div></div></div>`);
        }
      } else {
        return [
...
const RecycleScrollerDemo = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-b6eaf389"]]);
export {
