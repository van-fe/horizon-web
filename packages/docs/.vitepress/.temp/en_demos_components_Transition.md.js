...
`,
  ...
  _push(`<h2>Transition Api</h2><h3>Transition Props</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">name</td><td>动画名称</td><td><code>| &#39;fade-in&#39;<br>      | &#39;fade-in-linear&#39;<br>      | &#39;zoom-in-center&#39;<br>      | &#39;zoom-in-top&#39;<br>      | &#39;zoom-in-bottom&#39;<br>      | &#39;zoom-in-left&#39;<br>      | &#39;collapse&#39;<br>      | &#39;collapse-horizontal&#39;<br>      | &#39;float&#39;<br>      | &#39;slide-up&#39;<br>      | &#39;slide-right&#39;<br>      | &#39;slide-down&#39;<br>      | &#39;slide-left&#39;<br>      | &#39;dropdown&#39;<br>      | &#39;tooltip&#39;<br>      | &#39;none&#39;</code></td><td class="text-center">No</td><td>&#39;fade-in&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">group</td><td>是否是群组动画</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">speed</td><td>动画速度<br><code>dropdown</code> 有自带速度控制，无法自定义</td><td><code>&#39;normal&#39; | &#39;fast&#39; | &#39;slow&#39; | &#39;extra-fast&#39;</code></td><td class="text-center">No</td><td>&#39;normal&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">appear</td><td>出现时过渡</td><td><code>boolean</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">css</td><td>是否显式地向 <code>Vue</code> 表明可以跳过对 <code>CSS</code> 过渡的自动探测</td><td><code>boolean</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">mode</td><td>模式<br><code>group = true</code> 下无效</td><td><code>BaseTransitionProps[&#39;mode&#39;]</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">persisted</td><td>持久化</td><td><code>BaseTransitionProps[&#39;persisted&#39;]</code></td><td class="text-center">No</td><td></td></tr></tbody></table><h3>Transition Emits</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">before-enter</td><td rowspan="1">动画进入前调用</td><td rowspan="1">( el: <code>RendererElement</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">el</td><td><code>RendererElement</code></td><td>渲染的元素对象</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">enter</td><td rowspan="1">动画进入时调用</td><td rowspan="1">( el: <code>RendererElement</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">el</td><td><code>RendererElement</code></td><td>渲染的元素对象</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">after-enter</td><td rowspan="1">动画进入后调用</td><td rowspan="1">( el: <code>RendererElement</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">el</td><td><code>RendererElement</code></td><td>渲染的元素对象</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">before-leave</td><td rowspan="1">动画离开前调用</td><td rowspan="1">( el: <code>RendererElement</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">el</td><td><code>RendererElement</code></td><td>渲染的元素对象</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">leave</td><td rowspan="1">动画离开时调用</td><td rowspan="1">( el: <code>RendererElement</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">el</td><td><code>RendererElement</code></td><td>渲染的元素对象</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">after-leave</td><td rowspan="1">动画离开后调用</td><td rowspan="1">( el: <code>RendererElement</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">el</td><td><code>RendererElement</code></td><td>渲染的元素对象</td></tr></tbody></table></div>`);
}
