...
`,
  ...
  _push(`<h2 id="分组" tabindex="-1">分组 <a class="header-anchor" href="#分组" aria-label="Permalink to &quot;分组&quot;">​</a></h2><p>可以使用 <code>n-option-group</code> 来分组，具有具名分组和不具名分组</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-row>
    <h-col :span="6">
...
`,
  ...
  _push(`<h2 id="禁用" tabindex="-1">禁用 <a class="header-anchor" href="#禁用" aria-label="Permalink to &quot;禁用&quot;">​</a></h2><p>设置 <code>disabled = true</code> 即可禁用 <code>n-select</code></p><p>给 <code>n-option</code> 设置 <code>disabled = true</code>，即可禁用当前选项</p><p>给 <code>n-option-group</code> 设置 <code>disabled = true</code>，即可禁用当前组下的所有选项</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <div>
    <h-row>
...
`,
  ...
  _push(`<h2 id="辅助说明文字" tabindex="-1">辅助说明文字 <a class="header-anchor" href="#辅助说明文字" aria-label="Permalink to &quot;辅助说明文字&quot;">​</a></h2><p>给 <code>n-option.description</code> 设置内容，用来辅助说明 <code>label</code></p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-row>
    <h-col :span="6">
...
`,
  ...
  _push(`<h2 id="值的转化" tabindex="-1">值的转化 <a class="header-anchor" href="#值的转化" aria-label="Permalink to &quot;值的转化&quot;">​</a></h2><p>使用 <code>value-format</code>，传入一个函数，则可以对 <code>modelValue</code> 转化</p><p>请注意，仍然不建议使用 <code>value-format</code>，自 2.3.0 开始，<code>n-option.value</code> 已支持 <code>object</code> 类型</p><p>此方法会在 <code>3.x</code> 剔除</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-row :gutter="10">
    <h-col :span="6">
...
`,
  ...
  _push(`<h2 id="自定义选择标签" tabindex="-1">自定义选择标签 <a class="header-anchor" href="#自定义选择标签" aria-label="Permalink to &quot;自定义选择标签&quot;">​</a></h2><p>通过 <code>select.tagRender</code> 插槽可以自定义选择后的选项在输入框中的渲染表现</p><p>使用 <code>option.label</code> 插槽，可以自定义 <code>n-option</code> 中文本的展示形式</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<script setup lang="ts">
import { ref } from 'vue';
