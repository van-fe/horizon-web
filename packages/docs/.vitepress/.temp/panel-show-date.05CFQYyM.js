...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "panel-show-date",
  __ssrInlineRender: true,
  setup(__props) {
    const value = ref();
    const value2 = ref();
    const value3 = ref();
    const panelShowDate = [currDayjs().set("year", 2e3).set("month", 1), currDayjs().set("month", 10)];
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/DatePicker/panel-show-date.vue");
