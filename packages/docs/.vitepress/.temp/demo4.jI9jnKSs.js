...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div>`);
      if (showImage.value) {
        _push(`<!--[--><strong data-v-925f7288>图片内容</strong><div class="control-item" data-v-925f7288>`);
        _push(ssrRenderComponent(_component_h_input, {
      ...
      _push(`<strong data-v-925f7288>旋转角度</strong><div class="control-item" data-v-925f7288>`);
      _push(ssrRenderComponent(_component_h_input_number, {
        modelValue: rotate.value,
        "onUpdate:modelValue": ($event) => rotate.value = $event
      }, null, _parent));
      _push(`</div><strong data-v-925f7288>zIndex层级</strong><div class="control-item" data-v-925f7288>`);
      _push(ssrRenderComponent(_component_h_input_number, {
        modelValue: zIndex.value,
        "onUpdate:modelValue": ($event) => zIndex.value = $event
      }, null, _parent));
      _push(`</div><strong data-v-925f7288>多行文本垂直方向的间距</strong><div class="control-item" data-v-925f7288>`);
      _push(ssrRenderComponent(_component_h_input_number, {
        modelValue: lineGap.value,
        "onUpdate:modelValue": ($event) => lineGap.value = $event
      }, null, _parent));
      _push(`</div><strong data-v-925f7288>水平及垂直间距（gapX、gapY）</strong><div class="control-item" data-v-925f7288>`);
      _push(ssrRenderComponent(_component_h_input_number, {
      ...
      _push(`</div><strong data-v-925f7288>水平及垂直偏移量（offsetX、offsetY）</strong><div class="control-item" data-v-925f7288>`);
      _push(ssrRenderComponent(_component_h_input_number, {
      ...
      _push(`</div><strong data-v-925f7288>不透明度</strong><div class="control-item" data-v-925f7288>`);
      _push(ssrRenderComponent(_component_h_input_number, {
...
const demo4 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-925f7288"]]);
export {
  demo4 as default
};
