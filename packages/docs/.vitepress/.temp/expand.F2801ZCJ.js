          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_h_table_column, {
              ...
              expand: withCtx((scope, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(scope.row.desc)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(scope.row.desc), 1)
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Table/expand.vue");
