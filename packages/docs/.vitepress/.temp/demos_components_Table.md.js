...
`,
  ...
  _push(`<h2 id="拖拽列宽" tabindex="-1">拖拽列宽 <a class="header-anchor" href="#拖拽列宽" aria-label="Permalink to &quot;拖拽列宽&quot;">​</a></h2><p>默认情况下，每列都默认允许拖拽宽度，但如果需要配置某列不允许拖拽，请设置 <code>resizable = false</code> 即可</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-switch
