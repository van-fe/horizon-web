...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-demo" }, _attrs))} data-v-7aa76c3a><div class="h-demo__container" data-v-7aa76c3a><div class="h-demo__title" data-v-7aa76c3a>通过加载图片失败默认处理</div>`);
  _push(ssrRenderComponent(_component_h_avatar, {
    size: "large",
    src: _ctx.src1,
    onError: _ctx.errorHandler1
  }, null, _parent));
  _push(`</div><div class="h-demo__container" data-v-7aa76c3a><div class="h-demo__title" data-v-7aa76c3a>通过 error 方法自定义处理加载图片失败情况</div>`);
  _push(ssrRenderComponent(_component_h_avatar, {
    size: "large",
    src: _ctx.src,
    onError: _ctx.errorHandler
  }, null, _parent));
  _push(`</div><div class="h-demo__container" data-v-7aa76c3a><div class="h-demo__title" data-v-7aa76c3a>通过插槽自定义加载图片失败情况</div>`);
  _push(ssrRenderComponent(_component_h_avatar, {
    size: "large",
    src: _ctx.src2
  }, {
    error: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div data-v-7aa76c3a${_scopeId}>失败了</div>`);
      } else {
        return [
...
const error = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-7aa76c3a"]]);
export {
  error as default
};
