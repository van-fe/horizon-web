...
`,
  ...
  _push(`<h2 id="注释" tabindex="-1">注释 <a class="header-anchor" href="#注释" aria-label="Permalink to &quot;注释&quot;">​</a></h2><p>有注释效果的链接。文字链接不提供弹框，请使用 <code>n-popover</code> 包裹</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
  ...
  _push(`<h2 id="锚点" tabindex="-1">锚点 <a class="header-anchor" href="#锚点" aria-label="Permalink to &quot;锚点&quot;">​</a></h2><p>带有锚点，也可以设置 <code>anchor-offset</code> 滚动至距顶 px</p><p>因为本文档的内容放在了 <code>n-main</code> 中，所以需要设置 <code>scroll-target</code></p><p>需要注意的是:</p><ul><li>如果同时传入了 <code>anchor</code> 、 <code>to</code> 或 <code>href</code>，会忽略 <code>to</code> 与 <code>href</code></li><li>必须使用 history 的路由形式，hash 路由形式会影响锚点的使用</li></ul>`);
  _push(ssrRenderComponent(_component_demo_block, {
