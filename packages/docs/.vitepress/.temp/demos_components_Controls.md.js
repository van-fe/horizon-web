...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><h1>Controls</h1><p class="description">可以根据宽度自动控制显示的按钮数量</p><h2 id="基础使用" tabindex="-1">基础使用 <a class="header-anchor" href="#基础使用" aria-label="Permalink to &quot;基础使用&quot;">​</a></h2><p>和 <code>n-hover</code>、<code>n-mask</code> 联合使用，可以做到蒙层 <code>hover</code> 后显示控制器</p>`);
