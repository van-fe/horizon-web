...
`,
  ...
  _push(`<h2 id="async-load" tabindex="-1">Async Load <a class="header-anchor" href="#async-load" aria-label="Permalink to &quot;Async Load&quot;">​</a></h2><p>Because the <code>steps</code> component determines the index of each step only when <code>h-step</code> is mounted, if there are fixed front and back steps but the middle steps are loaded asynchronously, it will cause the final order to be incorrect</p><p>Therefore, you need to set <code>index</code> for <code>h-step</code> to ensure the order meets expectations</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-row :gutter="10">
    <h-col :span="24">
...
`,
  ...
  _push(`<h2 id="steps-api" class="no-underline h2"><a href="#steps-api" class="!no-underline">Steps Api</a></h2><h3 id="steps-props" class="no-underline h3"><a href="#steps-props" class="!no-underline">Steps Props</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">current</td><td>Configuration for current.</td><td><code>number</code></td><td class="text-center">No</td><td>0</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">v-model</td><td>Configuration for model value.</td><td><code>number</code></td><td class="text-center">No</td><td>0</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">direction</td><td>Configuration for direction.</td><td><code>&#39;horizontal&#39; | &#39;vertical&#39;</code></td><td class="text-center">No</td><td>&#39;horizontal&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">label-placement</td><td>Configuration for label placement.</td><td><code>&#39;horizontal&#39; | &#39;vertical&#39;</code></td><td class="text-center">No</td><td>&#39;horizontal&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">size</td><td>Configuration for size.</td><td><code>&#39;medium&#39; | &#39;small&#39;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">status</td><td>Configuration for status.</td><td><code>&#39;wait&#39; | &#39;process&#39; | &#39;finish&#39; | &#39;error&#39;</code></td><td class="text-center">No</td><td>&#39;process&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">progress-dot</td><td>Configuration for progress dot.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">clickable</td><td>Configuration for clickable.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">controllable</td><td>Configuration for controllable.</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">initial</td><td>Configuration for initial.</td><td><code>number</code></td><td class="text-center">No</td><td>0</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">label-align</td><td>Configuration for label align.</td><td><code>&#39;center&#39; | &#39;left&#39;</code></td><td class="text-center">No</td><td>&#39;center&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">before-change</td><td>Configuration for before change.</td><td><code>(<br>        next: number,<br>        current: number,<br>        nextProp: StepProps | undefined,<br>        currentProp: StepProps | undefined,<br>      ) =&gt; Awaitable&lt;boolean&gt;</code></td><td class="text-center">No</td><td></td></tr></tbody></table><h3 id="steps-emits" class="no-underline h3"><a href="#steps-emits" class="!no-underline">Steps Emits</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">update:current</td><td rowspan="1">Emitted when update:current changes.</td><td rowspan="1">( index: <code>number</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">index</td><td><code>number</code></td><td>The index value.</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">change</td><td rowspan="1">Emitted when change changes.</td><td rowspan="1">( current: <code>number</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">current</td><td><code>number</code></td><td>The current value.</td></tr></tbody></table><h2 id="step-api" class="no-underline h2"><a href="#step-api" class="!no-underline">Step Api</a></h2><h3 id="step-props" class="no-underline h3"><a href="#step-props" class="!no-underline">Step Props</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">title</td><td>Configuration for title.</td><td><code>string</code></td><td class="text-center">No</td><td>&#39;&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">subtitle</td><td>Configuration for subtitle.</td><td><code>string</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">description</td><td>Configuration for description.</td><td><code>string</code></td><td class="text-center">No</td><td>&#39;&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">index</td><td>Configuration for index.</td><td><code>number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">clickable</td><td>Configuration for clickable.</td><td><code>boolean</code></td><td class="text-center">No</td><td>undefined</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">disabled</td><td>Configuration for disabled.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr></tbody></table><h3 id="step-emits" class="no-underline h3"><a href="#step-emits" class="!no-underline">Step Emits</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="2" style="${ssrRenderStyle({ "word-break": "keep-all" })}">click</td><td rowspan="2">Emitted when click changes.</td><td rowspan="2">( evt: <code>Event</code>, index: <code>number</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">evt</td><td><code>Event</code></td><td>The evt value.</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">index</td><td><code>number</code></td><td>The index value.</td></tr></tbody></table></div>`);
}
