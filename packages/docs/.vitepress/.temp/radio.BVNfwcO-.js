    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_h_transfer, mergeProps({
        ...
        leftFilter: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="transfer-radio__filter" data-v-01d89120${_scopeId}>`);
        ...
        leftBody: withCtx(({ data: data2 }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="transfer-radio__left" data-v-01d89120${_scopeId}><!--[-->`);
            ssrRenderList(data2, (item) => {
              _push2(`<div class="transfer-radio__item" data-v-01d89120${_scopeId}>`);
              _push2(ssrRenderComponent(_component_h_radio, {
                ...
                default: withCtx((_, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="flex align-center" data-v-01d89120${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_h_avatar, {
                      size: "small",
                      src: item.avatar
                    }, null, _parent3, _scopeId2));
                    _push3(`<div class="ml-2 flex-1 flex flex-column overflow-hidden" data-v-01d89120${_scopeId2}><div style="${ssrRenderStyle({ "text-overflow": "ellipsis", "overflow": "hidden" })}" data-v-01d89120${_scopeId2}>${ssrInterpolate(item.name)}</div><div${ssrRenderAttrs(mergeProps({ style: { "text-overflow": "ellipsis", "overflow": "hidden", "color": "#929398" } }, ssrGetDirectiveProps(_ctx, _directive_tooltip, item.department, void 0, { overflow: true })))} data-v-01d89120${_scopeId2}>${ssrInterpolate(item.department)}</div></div></div>`);
                  } else {
                    return [
        ...
        item: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex align-center" data-v-01d89120${_scopeId}>`);
            _push2(ssrRenderComponent(_component_h_avatar, {
              size: "small",
              src: item.avatar
            }, null, _parent2, _scopeId));
            _push2(`<div class="ml-2 flex-1 flex flex-column overflow-hidden" data-v-01d89120${_scopeId}><div style="${ssrRenderStyle({ "text-overflow": "ellipsis", "overflow": "hidden" })}" data-v-01d89120${_scopeId}>${ssrInterpolate(item.name)}</div><div${ssrRenderAttrs(mergeProps({ style: { "text-overflow": "ellipsis", "overflow": "hidden", "color": "#929398" } }, ssrGetDirectiveProps(_ctx, _directive_tooltip, item.department, void 0, { overflow: true })))} data-v-01d89120${_scopeId}>${ssrInterpolate(item.department)}</div></div></div>`);
          } else {
            return [
              createVNode("div", { class: "flex align-center" }, [
                createVNode(_component_h_avatar, {
        ...
        rightHeader: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-1 align-center justify-space-between" data-v-01d89120${_scopeId}><div data-v-01d89120${_scopeId}>${ssrInterpolate(`已选: ${dataModel.value.length} 人`)}</div>`);
...
const radio = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-01d89120"]]);
export {
  radio as default
};
