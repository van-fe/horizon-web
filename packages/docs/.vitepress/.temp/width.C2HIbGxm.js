    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_h_tab, {
          label: "This is a very long page title and you can see ellipsis text",
          name: "tab1",
          "max-width": 280
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Tabs/width.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const width = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  width as default
};
