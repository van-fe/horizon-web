...
`,
  ...
  _push(`<h2>Menu Api</h2><h3>Menu Props</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">selected-value</td><td>选中菜单值</td><td><code>string</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">mode</td><td>菜单展示形式</td><td><code>&#39;horizontal&#39; | &#39;vertical&#39;</code></td><td class="text-center">No</td><td>&#39;vertical&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">theme</td><td>主题</td><td><code>&#39;default&#39; | &#39;gray&#39; | &#39;midnight&#39;</code></td><td class="text-center">No</td><td>&#39;default&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">collapse</td><td>菜单是否折叠，只在 <code>mode = &#39;vertical&#39;</code> 时可用</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">ellipsis</td><td>是否省略多余的子项，只有在 <code>mode = &#39;horizontal&#39;</code> 时可用</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">collapse-button</td><td>是否显示折叠按钮，只在 <code>mode = &#39;vertical&#39;</code> 时可用</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">collapse-forever</td><td>一级菜单带标题的永久折叠</td><td><code>boolean</code></td><td class="text-center">No</td><td>undefined</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">collapse-show-title</td><td>折叠显示标题</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">exclusive-expand</td><td>菜单展开是否互斥</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">menu-trigger</td><td>子菜单打开的方式，只有在 <code>mode = &#39;horizontal&#39;</code> 时可用</td><td><code>&#39;hover&#39; | &#39;click&#39;</code></td><td class="text-center">No</td><td>&#39;hover&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">router</td><td>是否使用 <code>vue-router</code> 模式导航。<br>启用后会根据子菜单的 <code>value</code> 或 <code>index</code> 作为路由 <code>path</code> 跳转</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">collapse-transition</td><td>是否启用折叠动画</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">height</td><td>高度，如果是 Number，会自动加上单位 px<br><code>mode = &#39;vertical&#39;</code> 时默认 <code>100%</code></td><td><code>number | string</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">active-type</td><td>激活态样式<br><code>mode = &#39;vertical&#39;</code> 只提供 <code>button</code> 样式<br><code>mode = &#39;horizontal&#39;</code> 默认 <code>link</code> 样式</td><td><code>&#39;button&#39; | &#39;link&#39;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">max-width</td><td>容器的最大宽度，只对 <code>mode = &#39;horizontal&#39;</code> 有效</td><td><code>string | number</code></td><td class="text-center">No</td><td>&#39;100%&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">submenu-expand-type</td><td>子菜单展开的模式，仅对 <code>mode = &#39;horizontal&#39;</code> 有效<br><code>single</code>: 只会对当前鼠标悬浮的菜单弹出弹窗<br><code>full</code>: 只要悬浮在菜单任意位置，会把所有子菜单都展示出来</td><td><code>&#39;single&#39; | &#39;full&#39;</code></td><td class="text-center">No</td><td>&#39;single&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">width</td><td>宽度<br>需要设置在 160 - 240 之间<br>仅在 <code>mode = vertical</code> 时有效</td><td><code>string | number</code></td><td class="text-center">No</td><td>240</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">resizable</td><td>是否可以拖拽调整大小</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">resize-to-collapse</td><td>是否允许在拖拽到一定程度后收起菜单栏</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">tag</td><td>使用哪种原生标签渲染</td><td><code>&#39;div&#39; | &#39;a&#39;</code></td><td class="text-center">No</td><td>&#39;div&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">before-select</td><td>选择前函数钩子<br>如果希望控制用户是否可以选择该菜单，可以传入函数判断，并返回一个 <code>boolean</code> 值告知是否可选择</td><td><code>(value: string, props: MenuItemProps | SubMenuProps) =&gt; Promisable&lt;boolean&gt;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">use-dropdown-level</td><td>在第几层级后开始使用 <code>dropdown</code> 展示子层级 （从 <code>0</code> 开始计数）</td><td><code>number</code></td><td class="text-center">No</td><td>2</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">is-default-expand-all</td><td>是否默认展开全部<br>只有在第一次挂载时有效，后期层级有变动请使用 <code>expandAll</code> 方法</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr></tbody></table><h3>Menu Emits</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">collapse-changed`);
