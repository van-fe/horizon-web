...
`,
  ...
  _push(`<h2 id="annotation" tabindex="-1">Annotation <a class="header-anchor" href="#annotation" aria-label="Permalink to &quot;Annotation&quot;">​</a></h2><p>Links with annotation effect. Text links do not provide popups, please use <code>n-popover</code> to wrap</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
  ...
  _push(`<h2 id="anchor" tabindex="-1">Anchor <a class="header-anchor" href="#anchor" aria-label="Permalink to &quot;Anchor&quot;">​</a></h2><p>With anchor, you can also set <code>anchor-offset</code> to scroll to px from the top</p><p>Because the content of this document is placed in <code>n-main</code>, you need to set <code>scroll-target</code></p><p>Note:</p><ul><li>If <code>anchor</code>, <code>to</code> or <code>href</code> are passed in at the same time, <code>to</code> and <code>href</code> will be ignored</li><li>Must use history routing form, hash routing form will affect the use of anchors</li></ul>`);
  _push(ssrRenderComponent(_component_demo_block, {
...
`,
  ...
  _push(`<h2>Link Api</h2><h3>Link Props</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">type</td><td>Type<br><code>default / text</code> 将被废弃</td><td><code>&#39;default&#39; | &#39;text&#39; | &#39;positive&#39; | &#39;neutral&#39; | &#39;negative&#39;</code></td><td class="text-center">No</td><td>&#39;positive&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">underline</td><td>是否启用下划线</td><td><code>boolean | &#39;always&#39;</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">disabled</td><td>是否禁用</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">href</td><td>原生hrefName</td><td><code>string</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">target</td><td>原生targetName</td><td><code>&#39;_blank&#39; | &#39;_self&#39; | &#39;_parent&#39; | &#39;_top&#39;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">attribute</td><td>是否有注释</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">anchor</td><td>锚点，会对当前 link 增加<code>id</code>为此值</td><td><code>string</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">anchor-position</td><td>锚点位置</td><td><code>&#39;right&#39; | &#39;left&#39;</code></td><td class="text-center">No</td><td>&#39;right&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">anchor-offset</td><td>锚点距顶部偏移px</td><td><code>number</code></td><td class="text-center">No</td><td>0</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">icon</td><td>字体，即 <code>a-icon</code> 的 <code>name</code> Name，或直接传入 icon 对象</td><td><code>iconPropType</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">icon-size</td><td><code>a-icon</code> 的 <code>size</code> Name</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">to</td><td>路由跳转对象，同 <code>vue-router</code> 的 <code>to</code></td><td><code>RouteLocationRaw</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">replace</td><td>在使用 to 进行路由跳转时，启用 replace 将不会向 history 添加新记录</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">scroll-target</td><td>滑动的外包容器，默认为 <code>body</code><br>设置的如果是 <code>string</code> Type，会传入 <code>document.querySelector</code> 获取元素</td><td><code>string | Element</code></td><td class="text-center">No</td><td>&#39;body&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">size</td><td>大小</td><td><code>&#39;small&#39; | &#39;medium&#39; | &#39;large&#39;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">loading</td><td>是否正在加载，内容文字会被国际化替换<br>需要注意的是，加载中的 <code>link</code> 会忽视 <code>click</code> 事件</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr></tbody></table><h3>Link Emits</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">click</td><td rowspan="1">点击链接后的事件</td><td rowspan="1">( event: <code>MouseEvent</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">event</td><td><code>MouseEvent</code></td><td>鼠标事件</td></tr></tbody></table></div>`);
}
