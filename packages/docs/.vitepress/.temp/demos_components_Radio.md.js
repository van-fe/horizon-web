...
`,
  ...
  _push(`<h2 id="按钮样式" tabindex="-1">按钮样式 <a class="header-anchor" href="#按钮样式" aria-label="Permalink to &quot;按钮样式&quot;">​</a></h2><p>只需要把<code>n-radio</code>元素换成<code>n-radio-button</code>元素即可，同时提供<code>size</code>属性控制大小</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-row>
    <h-col :span="8">
...
`,
  ...
  _push(`<h2 id="多选框组" tabindex="-1">多选框组 <a class="header-anchor" href="#多选框组" aria-label="Permalink to &quot;多选框组&quot;">​</a></h2><p>结合<code>n-radio-group</code>和<code>n-radio</code>或者<code>n-radio-button</code>可以实现单选框组，用于多个互斥选项</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-row>
    <h-col :span="24">
