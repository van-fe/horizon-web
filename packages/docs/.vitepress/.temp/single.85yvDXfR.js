        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_h_col, { span: 6 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title"${_scopeId2}>有 Radio 组件</div>`);
                  _push3(ssrRenderComponent(_component_h_tree_select, {
                  ...
                  return [
                    createVNode("div", { class: "demo-title" }, "有 Radio 组件"),
                    createVNode(_component_h_tree_select, {
                      modelValue: value2.value,
                      "onUpdate:modelValue": ($event) => value2.value = $event,
                      "tree-data": baseTreeData.value,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/TreeSelect/single.vue");
