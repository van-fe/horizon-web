...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_h_empty, mergeProps({ size: 120 }, _attrs), {
    image: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="my-img"${_scopeId}><img src="https://static.example.com/fx-static/issue-management/clbn4wr6r000807742tv19ro7/img-default.svg" alt="img"${_scopeId}></div>`);
      } else {
        return [
