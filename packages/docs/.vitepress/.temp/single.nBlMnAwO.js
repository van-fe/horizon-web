...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))} data-v-d917223c><div data-v-d917223c> small `);
  ...
  _push(`</div><div data-v-d917223c> medium `);
  _push(ssrRenderComponent(_component_h_descriptions, {
    title: "User Info",
    type: "vertical"
  }, {
  ...
  _push(`</div><div data-v-d917223c> large `);
  _push(ssrRenderComponent(_component_h_descriptions, {
    title: "User Info",
    type: "vertical",
    size: "large"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Descriptions/single.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const single = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-d917223c"]]);
export {
  single as default
};
