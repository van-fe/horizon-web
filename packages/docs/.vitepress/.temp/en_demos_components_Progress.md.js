...
`,
  ...
  _push(`<h2>Progress Api</h2><h3>Progress Props</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">type</td><td>进度条Type</td><td><code>string</code></td><td class="text-center">No</td><td>&#39;line&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">percentage</td><td>百分比</td><td><code>number</code></td><td class="text-center">Yes</td><td>0</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">status</td><td>进度条当前状态</td><td><code>&#39;success&#39; | &#39;exception&#39; | &#39;error&#39; | &#39;warning&#39;</code></td><td class="text-center">No</td><td>&#39;&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">duration</td><td>控制动画进度条速度</td><td><code>number</code></td><td class="text-center">No</td><td>3</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">size</td><td>进度条的大小，四个Type可选</td><td><code>&#39;mini&#39; | &#39;small&#39; | &#39;medium&#39; | &#39;large&#39;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">format</td><td>指定进度条文字内容</td><td><code>(percentage: number) =&gt; string</code></td><td class="text-center">No</td><td>(percentage: number): string =&gt; <code>\${percentage}%</code></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">content</td><td>自定义文本内容</td><td><code>string | number | boolean</code></td><td class="text-center">No</td><td>&#39;&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">placement</td><td>自定义文本的显示位置，type为line时可用</td><td><code>string</code></td><td class="text-center">No</td><td>&#39;&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">text-bold</td><td>文本内容是否加粗</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">show-text</td><td>是否显示进度条文字内容</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">color</td><td>进度条背景色 进度条背景色 （会覆盖 status 状态颜色）</td><td><code>string | Color[] | ProgressFn</code></td><td class="text-center">No</td><td>&#39;&#39;</td></tr></tbody></table></div>`);
}
