...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "format-trigger-text",
  __ssrInlineRender: true,
  setup(__props) {
    const value = ref();
    const value2 = ref();
    const formatTriggerText = (days, text) => {
      console.info("format trigger text param: ", days, text);
      if (Array.isArray(days)) {
        return days.map((day) => day == null ? void 0 : day.format("YYYY-MM-DD HH:mm:ss")).join(" 至 ");
      } else {
        return (days == null ? void 0 : days.format("YYYY-MM-DD HH:mm:ss")) || "";
      }
    };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/DatePicker/format-trigger-text.vue");
