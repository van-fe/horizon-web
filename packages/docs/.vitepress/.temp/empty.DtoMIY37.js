          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_h_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title" data-v-34ee466c${_scopeId2}> 自定义空样式 </div>`);
                  _push3(ssrRenderComponent(_component_h_select, {
                    ...
                    empty: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="empty-city" data-v-34ee466c${_scopeId3}>没有找到对应的城市信息</div>`);
                      } else {
                        return [
            ...
            _push2(ssrRenderComponent(_component_h_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title" data-v-34ee466c${_scopeId2}> 使用 h-empty 组件 </div>`);
                  _push3(ssrRenderComponent(_component_h_select, {
                    modelValue: value.value,
                    "onUpdate:modelValue": ($event) => value.value = $event,
                    "filter-option": "",
                  ...
                  return [
                    createVNode("div", { class: "demo-title" }, " 使用 h-empty 组件 "),
                    createVNode(_component_h_select, {
                      modelValue: value.value,
                      "onUpdate:modelValue": ($event) => value.value = $event,
                      "filter-option": "",
...
const empty = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-34ee466c"]]);
export {
  empty as default
};
