...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "colors" }, _attrs))} data-v-a6c0f2f5><!--[-->`);
      ssrRenderList(unref(elementListTokens).shadow, (token) => {
        _push(`<div class="color" data-v-a6c0f2f5><div class="label" data-v-a6c0f2f5><div class="key" data-v-a6c0f2f5>${ssrInterpolate(token.refToken)} `);
        _push(ssrRenderComponent(_component_copy_btn, {
          text: token.refToken
        }, null, _parent));
        _push(`</div></div><div class="value" data-v-a6c0f2f5>${ssrInterpolate(token.value)}</div></div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const shadow_NoCode = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a6c0f2f5"]]);
export {
