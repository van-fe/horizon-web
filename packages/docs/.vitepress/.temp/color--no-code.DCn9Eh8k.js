...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const getInstanceValue = (basicToken, colors) => {
      const basicKey = snakeCase(basicToken.replace("--h-", ""));
      return getHexValue(colors[basicKey]);
    };
    const getAlphaInstanceValue = (alphaToken, opacity) => {
      const basicKey = snakeCase(alphaToken.replace("--h-", ""));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "colors" }, _attrs))} data-v-f448afee>`);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    ssrRenderList(group.children, (color) => {
                      _push3(`<div class="${ssrRenderClass({ "color": true, "inverse": color.refToken.includes("inverse") })}" data-v-f448afee${_scopeId2}><div class="label" data-v-f448afee${_scopeId2}><div class="preview" data-v-f448afee${_scopeId2}><div class="color" style="${ssrRenderStyle({ backgroundColor: color.hex8 })}" data-v-f448afee${_scopeId2}></div></div><div class="key" data-v-f448afee${_scopeId2}>${ssrInterpolate(color.refToken)} `);
                      ...
                      _push3(ssrRenderComponent(_component_h_tooltip, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="value" data-v-f448afee${_scopeId3}>#${ssrInterpolate(color.showValue.replace(/-/g, "_"))} @ ${ssrInterpolate(color.alphaJsKey)}</div>`);
                          } else {
                            return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  ssrRenderList(unref(alphaTokens), (opacity) => {
                    _push3(`<div class="color" data-v-f448afee${_scopeId2}><div class="label" data-v-f448afee${_scopeId2}><div class="preview" data-v-f448afee${_scopeId2}><div class="color" style="${ssrRenderStyle({ backgroundColor: `rgba(255, 255, 255, ${opacity.value})` })}" data-v-f448afee${_scopeId2}></div></div><div class="key" data-v-f448afee${_scopeId2}>${ssrInterpolate(opacity.refToken)} `);
                    _push3(ssrRenderComponent(_component_copy_btn, {
                      text: opacity.refToken
                    }, null, _parent3, _scopeId2));
                    _push3(`</div></div><div class="value" data-v-f448afee${_scopeId2}>${ssrInterpolate(opacity.value)}</div></div>`);
                  });
                  _push3(`<!--]-->`);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("zh/features/tokens/demos/color--no-code.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const color_NoCode = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f448afee"]]);
export {
