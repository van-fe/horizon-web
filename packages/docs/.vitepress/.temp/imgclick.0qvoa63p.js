...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList(_ctx.imagesRef, (item) => {
    _push(`<img${ssrRenderAttr("src", item.thumbnail)}${ssrRenderAttr("data-source", item.cover)}${ssrRenderAttr("alt", item.title)} class="mr-3" data-v-2b6d7946>`);
  });
  _push(`<!--]-->`);
...
const imgclick = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-2b6d7946"]]);
export {
  imgclick as default
};
