...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><h2 id="指令说明" tabindex="-1">指令说明 <a class="header-anchor" href="#指令说明" aria-label="Permalink to &quot;指令说明&quot;">​</a></h2><p>在需要的时候展示加载动画，防止页面失去响应提高用户体验（例如在请求数据后生产的图表）。horizonweb组件库通过自定义指令的方式使用loading。 对于自定义指令 v-loading，传入一个对象，且这个对象的各个value值为响应式数据，如demo1/demo2中的示例所示。</p><h2 id="loading加载" tabindex="-1">loading加载 <a class="header-anchor" href="#loading加载" aria-label="Permalink to &quot;loading加载&quot;">​</a></h2>`);
