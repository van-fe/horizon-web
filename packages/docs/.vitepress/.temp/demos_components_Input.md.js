...
`,
  ...
  _push(`<h2 id="组合式输入框" tabindex="-1">组合式输入框 <a class="header-anchor" href="#组合式输入框" aria-label="Permalink to &quot;组合式输入框&quot;">​</a></h2><p>通过<code>prepend</code>和<code>append</code> <code>slot</code>可以为输入框添加一个前置或后置元素<br><code>--h-input-bg--prepend-append: transparent</code> 为了解决图标和前后缀的背景色问题</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
...
`,
  ...
  _push(`<h2 id="字数限制" tabindex="-1">字数限制 <a class="header-anchor" href="#字数限制" aria-label="Permalink to &quot;字数限制&quot;">​</a></h2><p>通过<code>maxlength</code>和<code>showLimit</code>可显示输入框的字数限制</p><p>注意: 启用了 <code>enable-out-of-exceeded</code> 后，不会限制字数，所以表单验证需要结合 <code>h-form</code> 的 <code>max</code> 设置</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
