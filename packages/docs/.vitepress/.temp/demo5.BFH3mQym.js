...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "wrapper" }, _attrs))} data-v-5c4526e1>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Anchor/demo5.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const demo5 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5c4526e1"]]);
export {
  demo5 as default
};
