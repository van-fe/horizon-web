...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "colors" }, _attrs))} data-v-a815b7aa><!--[-->`);
      ssrRenderList(unref(elementListTokens).shadow, (token) => {
        _push(`<div class="color" data-v-a815b7aa><div class="label" data-v-a815b7aa><div class="key" data-v-a815b7aa>${ssrInterpolate(token.refToken)} `);
        _push(ssrRenderComponent(_component_copy_btn, {
          text: token.refToken
        }, null, _parent));
        _push(`</div></div><div class="value" data-v-a815b7aa>${ssrInterpolate(token.value)}</div></div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("zh/features/tokens/demos/shadow--no-code.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const shadow_NoCode = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a815b7aa"]]);
export {
  shadow_NoCode as default
};
