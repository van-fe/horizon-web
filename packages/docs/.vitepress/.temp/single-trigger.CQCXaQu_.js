...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "single-trigger",
  __ssrInlineRender: true,
  setup(__props) {
    const value = ref();
    const value2 = ref([currDayjs().subtract(1, "month"), currDayjs().add(4, "month")]);
    const value3 = ref();
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_h_date_picker, {
                    ...
                    type: "dateRange",
                    "single-trigger": "",
                    placeholder: "Do Not Link Panels",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/DatePicker/single-trigger.vue");
