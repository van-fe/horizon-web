...
`,
  ...
  _push(`<h2>Breadcrumb Api</h2><h3>Breadcrumb Props</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">separator</td><td>分隔符</td><td><code>string | Component</code></td><td class="text-center">No</td><td>&#39;/&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">title</td><td>用作标题展示，最后一项激活的 item 会加粗展示</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">texts</td><td>需要渲染的内容数组</td><td><code>BreadcrumbItem[]</code></td><td class="text-center">No</td><td>() =&gt; []</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">size</td><td>尺寸</td><td><code>&#39;small&#39; | &#39;medium&#39;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">display-type</td><td>展示方式<br>full: 不折叠，全部展示<br>ellipsis: 在超过最大宽度后，会自动从第二个 item 开始折叠起来，并用 dropdown 显示</td><td><code>&#39;full&#39; | &#39;ellipsis&#39;</code></td><td class="text-center">No</td><td>&#39;full&#39;</td></tr></tbody></table><h3>Breadcrumb Emits</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="2" style="${ssrRenderStyle({ "word-break": "keep-all" })}">item-click</td><td rowspan="2">点击子元素后触发</td><td rowspan="2">( itemProp: <code>BreadcrumbItem</code>, e: <code>Event</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">itemProp</td><td><code>BreadcrumbItem</code></td><td>子元素的 <code>prop</code></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">e</td><td><code>Event</code></td><td>点击事件或键盘事件</td></tr></tbody></table><h2>BreadcrumbItem Api</h2><h3>BreadcrumbItem Props</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">separator</td><td>分隔符</td><td><code>string | Component</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">title</td><td>用作标题展示，最后一项激活的 item 会加粗展示</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">to</td><td>路由跳转对象，同 vue-router 的 to</td><td><code>RouteLocationRaw</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">replace</td><td>在使用 to 进行路由跳转时，启用 replace 将不会向 history 添加新记录</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">size</td><td>尺寸</td><td><code>&#39;small&#39; | &#39;medium&#39;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">clickable</td><td>是否可点击，点击后会对外抛出 <code>click</code> 事件<br>如果设置了 <code>prop.to</code>，无需额外设置此值</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr></tbody></table><h3>BreadcrumbItem Emits</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">click</td><td rowspan="1">点击后触发</td><td rowspan="1">( e: <code>MouseEvent</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">e</td><td><code>MouseEvent</code></td><td>点击事件</td></tr></tbody></table></div>`);
}
