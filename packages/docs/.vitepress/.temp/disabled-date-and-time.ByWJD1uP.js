...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function disabledDate(date) {
      return date.isBefore(currDayjs().startOf("week"), "date") || date.isAfter(currDayjs().add(7, "days").endOf("week"), "date");
    }
    function disabledTime(time) {
      return time.isBefore(currDayjs().set("hour", 9).set("minute", 30), "minute") || time.isAfter(currDayjs().set("hour", 18), "hour");
    }
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_h_date_picker, {
                    ...
                    type: "datetimeRange",
                    "disabled-date": disabledDate,
                    "begih-disabled-time": disabledTime,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/DatePicker/disabled-date-and-time.vue");
