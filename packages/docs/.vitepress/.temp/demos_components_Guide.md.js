...
`,
  ...
  _push(`<h2 id="直接传参使用" tabindex="-1">直接传参使用 <a class="header-anchor" href="#直接传参使用" aria-label="Permalink to &quot;直接传参使用&quot;">​</a></h2><p>某些情况下，可以不需要使用 <code>h-guide-item</code> 组件构建步骤，可以直接传入数据构建</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-row>
    <h-col :span="24">
