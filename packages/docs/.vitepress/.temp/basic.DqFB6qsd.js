                  ...
                  _push3(ssrRenderComponent(_component_h_radio_group, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_h_radio, { value: "large" }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(_component_h_radio, { value: "small" }),
                          createVNode(_component_h_radio, { value: "medium" }),
                          createVNode(_component_h_radio, { value: "large" })
                        ];
                      }
                    }),
                    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/DatePicker/basic.vue");
