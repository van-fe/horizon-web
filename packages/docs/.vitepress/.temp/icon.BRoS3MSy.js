...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_h_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Open New Link `);
      } else {
        return [
          createTextVNode(" Open New Link ")
        ];
      }
    }),
    _: 1
  ...
  _push(ssrRenderComponent(_component_h_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Open Visited Link `);
      } else {
        return [
          createTextVNode(" Open Visited Link ")
        ];
      }
    }),
    _: 1
  ...
  _push(ssrRenderComponent(_component_h_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Disable Open Link `);
      } else {
        return [
          createTextVNode(" Disable Open Link ")
        ];
      }
    }),
    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Link/icon.vue");
