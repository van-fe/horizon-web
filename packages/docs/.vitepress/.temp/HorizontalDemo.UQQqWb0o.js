...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "virtual-scroller-horizontal" }, _attrs))} data-v-414cefca><section class="toolbar" data-v-414cefca>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_h_virtual_scroller_item, {
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="avatar-h" data-v-414cefca${_scopeId2}><img${ssrRenderAttr("src", item.avatar)} alt="avatar" class="image-h" data-v-414cefca${_scopeId2}></div><div class="text-h" data-v-414cefca${_scopeId2}>${ssrInterpolate(item.message)}</div><div class="index-h" data-v-414cefca${_scopeId2}><span data-v-414cefca${_scopeId2}>${ssrInterpolate(item.id)} (id)</span><span data-v-414cefca${_scopeId2}>${ssrInterpolate(index)} (index)</span></div>`);
                } else {
                  return [
...
const HorizontalDemo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-414cefca"]]);
export {
