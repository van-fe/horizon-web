...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const values = ref();
    onMounted(() => {
      fetch(new URL("/unselectable-options.json", import.meta.url).href).then((res) => res.json()).then((res) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/TreeSelect/selectable.vue");
