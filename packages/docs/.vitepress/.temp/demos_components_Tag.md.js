...
`,
  ...
  _push(`<h2 id="新建、修改标签" tabindex="-1">新建、修改标签 <a class="header-anchor" href="#新建、修改标签" aria-label="Permalink to &quot;新建、修改标签&quot;">​</a></h2><p>通过 <code>n-tag-group</code> 的 <code>props.useCreate</code> 快速创建一个允许输入创建的标签</p><p>配合 <code>max-tags</code>，可以在标签数量达到一定值后不显示创建标签</p><p>给 <code>n-tag</code> 或 <code>n-tag-group</code> 设置 <code>editable = true</code> ，则允许标签进行编辑</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
