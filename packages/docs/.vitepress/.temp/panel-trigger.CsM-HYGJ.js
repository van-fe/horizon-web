      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_h_col, { span: 6 }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div class="demo-title"${_scopeId2}> 点击 </div>`);
              ...
              return [
                createVNode("div", { class: "demo-title" }, " 点击 "),
        ...
        _push2(ssrRenderComponent(_component_h_col, { span: 6 }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div class="demo-title"${_scopeId2}> 悬浮 </div>`);
              _push3(ssrRenderComponent(_component_h_cascader, {
              ...
              return [
                createVNode("div", { class: "demo-title" }, " 悬浮 "),
                createVNode(_component_h_cascader, {
                  modelValue: _ctx.currentVal2,
                  "onUpdate:modelValue": ($event) => _ctx.currentVal2 = $event,
                  options: _ctx.options,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Cascader/panel-trigger.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const panelTrigger = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  panelTrigger as default
};
