...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "wrapper" }, _attrs))} data-v-52ae3d5e><div class="content-box" data-v-52ae3d5e>`);
      ...
      _push(`</div><div class="control-box" data-v-52ae3d5e><strong data-v-52ae3d5e>全局模式</strong><div class="control-item" data-v-52ae3d5e>`);
      _push(ssrRenderComponent(_component_h_switch, {
        modelValue: global.value,
        "onUpdate:modelValue": ($event) => global.value = $event
      }, null, _parent));
      _push(`</div><strong data-v-52ae3d5e>文本内容</strong><div class="control-item" data-v-52ae3d5e>`);
      _push(ssrRenderComponent(_component_h_input, {
        modelValue: content.value,
        "onUpdate:modelValue": ($event) => content.value = $event
      }, null, _parent));
      _push(`</div><strong data-v-52ae3d5e>是否显示图片内容</strong><div class="control-item" data-v-52ae3d5e>`);
      _push(ssrRenderComponent(_component_h_switch, {
      ...
      _push(`</div>`);
      if (showImage.value) {
        _push(`<!--[--><strong data-v-52ae3d5e>图片内容</strong><div class="control-item" data-v-52ae3d5e>`);
        _push(ssrRenderComponent(_component_h_input, {
      ...
      _push(`<strong data-v-52ae3d5e>旋转角度</strong><div class="control-item" data-v-52ae3d5e>`);
      _push(ssrRenderComponent(_component_h_input_number, {
        modelValue: rotate.value,
        "onUpdate:modelValue": ($event) => rotate.value = $event
      }, null, _parent));
      _push(`</div><strong data-v-52ae3d5e>zIndex层级</strong><div class="control-item" data-v-52ae3d5e>`);
      _push(ssrRenderComponent(_component_h_input_number, {
        modelValue: zIndex.value,
        "onUpdate:modelValue": ($event) => zIndex.value = $event
      }, null, _parent));
      _push(`</div><strong data-v-52ae3d5e>多行文本垂直方向的间距</strong><div class="control-item" data-v-52ae3d5e>`);
      _push(ssrRenderComponent(_component_h_input_number, {
        modelValue: lineGap.value,
        "onUpdate:modelValue": ($event) => lineGap.value = $event
      }, null, _parent));
      _push(`</div><strong data-v-52ae3d5e>水平及垂直间距（gapX、gapY）</strong><div class="control-item" data-v-52ae3d5e>`);
      _push(ssrRenderComponent(_component_h_input_number, {
      ...
      _push(`</div><strong data-v-52ae3d5e>水平及垂直偏移量（offsetX、offsetY）</strong><div class="control-item" data-v-52ae3d5e>`);
      _push(ssrRenderComponent(_component_h_input_number, {
      ...
      _push(`</div><strong data-v-52ae3d5e>不透明度</strong><div class="control-item" data-v-52ae3d5e>`);
      _push(ssrRenderComponent(_component_h_input_number, {
...
const demo4 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-52ae3d5e"]]);
export {
  demo4 as default
};
