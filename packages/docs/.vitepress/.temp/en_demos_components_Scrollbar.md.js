...
`,
  ...
  _push(`<h2>Scrollbar Api</h2><h3>Scrollbar Props</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">size</td><td>尺寸<br><code>medium</code> 适用于页面、抽屉、弹窗、容器中<br><code>small</code> 适用于下拉弹层、编辑器中</td><td><code>&#39;medium&#39; | &#39;small&#39;</code></td><td class="text-center">No</td><td>&#39;medium&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">height</td><td>滚动条高度</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">max-height</td><td>滚动条最大高度</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">native</td><td>是否使用原生滚动条</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">wrap-style</td><td>包裹容器的自定义样式</td><td><code>CSSProperties</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">wrap-class</td><td>包裹容器的类名</td><td><code>string</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">view-style</td><td>视窗容器的自定义样式</td><td><code>CSSProperties</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">view-class</td><td>视窗容器的类名</td><td><code>string</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">no-resize</td><td>是否不响应父级容器的尺寸变化，以减少性能问题</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">tag</td><td>视图的元素标签</td><td><code>string</code></td><td class="text-center">No</td><td>&#39;div&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">always</td><td>是否总是显示滚动条</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">min-size</td><td>滚动条轨道的最小尺寸</td><td><code>number</code></td><td class="text-center">No</td><td>20</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">z-index</td><td>滚动条轨道层级</td><td><code>number | &#39;auto&#39; | &#39;inherit&#39; | &#39;initial&#39; | &#39;unset&#39; | <code>var(\${string})</code></code></td><td class="text-center">No</td><td>1</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">update-delay</td><td>更新延迟毫秒<br>容器有出现动画时需要设置，否则滚动条高度不正确</td><td><code>number</code></td><td class="text-center">No</td><td>400</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">horizontal-visible</td><td>水平滚动条是否可见</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">vertical-visible</td><td>垂直滚动条是否可见</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">track-begin-end-spacing</td><td>轨道首尾边距<br>对于垂直滚动条，是 上下 间距<br>对于水平滚动条，是 左右 间距<br>传入数字，即 上下左右 都是此值<br>传入数组，即按照 [[上，下]，[左，右]] 的顺序</td><td><code>number | [[number, number], [number, number]]</code></td><td class="text-center">No</td><td>0</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">prevent-scroll-by-track-begin-end-spacing</td><td>是否根据轨道首尾边距判断而禁止滚动</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">track-sticky</td><td>滚动条是否粘性定位</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr></tbody></table><h3>Scrollbar Emits</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="2" style="${ssrRenderStyle({ "word-break": "keep-all" })}">scroll</td><td rowspan="2">滚动时触发</td><td rowspan="2">( position: <code>{ scrollLeft: number; scrollTop: number }</code>, e: <code>Event</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">position</td><td><code>{ scrollLeft: number; scrollTop: number }</code></td><td>scrollLeft: 滚动距左; scrollTop 滚动距上</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">e</td><td><code>Event</code></td><td>滚动事件</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">update</td><td rowspan="1">当滚动条重新计算时触发</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">scroll-end</td><td rowspan="1">滚动结束时触发</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">reach-top</td><td rowspan="1">在触顶时触发</td><td rowspan="1">( e: <code>Event</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">e</td><td><code>Event</code></td><td>滚动事件</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">reach-bottom</td><td rowspan="1">在触底时触发</td><td rowspan="1">( e: <code>Event</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">e</td><td><code>Event</code></td><td>滚动事件</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">reach-left</td><td rowspan="1">在触左时触发</td><td rowspan="1">( e: <code>Event</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">e</td><td><code>Event</code></td><td>滚动事件</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">reach-right</td><td rowspan="1">在触右时触发</td><td rowspan="1">( e: <code>Event</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">e</td><td><code>Event</code></td><td>滚动事件</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">mouse-enter</td><td rowspan="1">鼠标进入</td><td rowspan="1">( e: <code>MouseEvent</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">e</td><td><code>MouseEvent</code></td><td>鼠标事件</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">mouse-leave</td><td rowspan="1">鼠标离开</td><td rowspan="1">( e: <code>MouseEvent</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">e</td><td><code>MouseEvent</code></td><td>鼠标事件</td></tr></tbody></table><h3>Scrollbar Exposes</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Input/Output</th><th>Input/Output Type</th><th>Input/Output Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">handleScroll</td><td rowspan="1">触发滚动事件</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="2" style="${ssrRenderStyle({ "word-break": "keep-all" })}">scrollTo</td><td rowspan="2">滚动到具体的坐标</td><td rowspan="2">( positionOrToLeft: <code>ScrollToOptions | number</code>, toTop: <code>number</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">positionOrToLeft</td><td><code>ScrollToOptions | number</code></td><td>left: 距左px, top：距顶px 或 距左px</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">toTop</td><td><code>number</code></td><td>距顶部(可选)</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">setScrollTop</td><td rowspan="1">设置滚动距顶px</td><td rowspan="1">( top: <code>number</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">top</td><td><code>number</code></td><td>距顶部px</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">setScrollLeft</td><td rowspan="1">设置滚动距左px</td><td rowspan="1">( left: <code>number</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">left</td><td><code>number</code></td><td>距左px</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">update</td><td rowspan="1">更新滚动条的状态</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">wrapRef</td><td rowspan="1">包裹容器的 <code>ref</code> 对象</td><td rowspan="1"><code>Ref&lt;HTMLElement | null&gt;</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">viewRef</td><td rowspan="1">容器视窗的 <code>ref</code> 对象</td><td rowspan="1"><code>Ref&lt;HTMLElement | null&gt;</code></td><td>-</td><td>-</td><td>-</td></tr></tbody></table></div>`);
}
