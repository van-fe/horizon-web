...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"demos/components/Card.md","filePath":"zh/demos/components/Card.md"}');
const _sfc_main = { name: "demos/components/Card.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_demo_block = resolveComponent("demo-block");
  _push(`<div${ssrRenderAttrs(_attrs)}><h1>Card</h1><p class="description">卡片组件</p><h2 id="基本用法" tabindex="-1">基本用法 <a class="header-anchor" href="#基本用法" aria-label="Permalink to &quot;基本用法&quot;">​</a></h2>`);
...
`,
  ...
  _push(`<h2 id="自定义header" tabindex="-1">自定义Header <a class="header-anchor" href="#自定义header" aria-label="Permalink to &quot;自定义Header&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <ul>
    <li>
...
`,
  ...
  _push(`<h2 id="自定义content" tabindex="-1">自定义Content <a class="header-anchor" href="#自定义content" aria-label="Permalink to &quot;自定义Content&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <div class="content">
    <h-card title="标题">
...
`,
  ...
  _push(`<h2 id="自定义footer-带状态" tabindex="-1">自定义Footer-带状态 <a class="header-anchor" href="#自定义footer-带状态" aria-label="Permalink to &quot;自定义Footer-带状态&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
  ...
  _push(`<h2 id="其他场景" tabindex="-1">其他场景 <a class="header-anchor" href="#其他场景" aria-label="Permalink to &quot;其他场景&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <div class="flex">
    <h-card
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("zh/demos/components/Card.md");
