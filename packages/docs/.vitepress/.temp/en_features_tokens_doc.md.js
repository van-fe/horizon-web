...
const __pageData = JSON.parse('{"title":"Tokens","description":"","frontmatter":{},"headers":[],"relativePath":"en/features/tokens/doc.md","filePath":"en/features/tokens/doc.md"}');
const _sfc_main = { name: "en/features/tokens/doc.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_demo_block = resolveComponent("demo-block");
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="tokens" tabindex="-1">Tokens <a class="header-anchor" href="#tokens" aria-label="Permalink to &quot;Tokens&quot;">​</a></h1><p>In <code>horizon-web</code>, we provide many <code>Tokens</code> to constrain various forms of components, including 6 major aspects: color, font size, border radius, spacing, shadow, and animation parameters.</p><p>You can also use these <code>Tokens</code> to develop in your own business system. Only when the semantics of using <code>Tokens</code> are the same, after theme replacement, will there be a consistent style form with <code>horizon-web</code>.</p><h2 id="color" tabindex="-1">Color <a class="header-anchor" href="#color" aria-label="Permalink to &quot;Color&quot;">​</a></h2>`);
...
`,
    path: "en/features/tokens/demos/color--no-code.vue"
  }, null, _parent));
  _push(`<h2 id="font-size" tabindex="-1">Font Size <a class="header-anchor" href="#font-size" aria-label="Permalink to &quot;Font Size&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<script setup lang="ts">
import tokens from './theme.json';
import { snakeCase } from '@aurora/utils';
...
`,
    path: "en/features/tokens/demos/font-size--no-code.vue"
  }, null, _parent));
  _push(`<h2 id="border-radius" tabindex="-1">Border Radius <a class="header-anchor" href="#border-radius" aria-label="Permalink to &quot;Border Radius&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<script setup lang="ts">
import tokens from './theme.json';
import { snakeCase } from '@aurora/utils';
...
`,
    path: "en/features/tokens/demos/radius--no-code.vue"
  }, null, _parent));
  _push(`<h2 id="spacing" tabindex="-1">Spacing <a class="header-anchor" href="#spacing" aria-label="Permalink to &quot;Spacing&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<script setup lang="ts">
import tokens from './theme.json';
import { snakeCase } from '@aurora/utils';
...
`,
    path: "en/features/tokens/demos/spacing--no-code.vue"
  }, null, _parent));
  _push(`<h2 id="shadow" tabindex="-1">Shadow <a class="header-anchor" href="#shadow" aria-label="Permalink to &quot;Shadow&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<script setup lang="ts">
import tokens from './theme.json';
import { snakeCase } from '@aurora/utils';
...
`,
    path: "en/features/tokens/demos/shadow--no-code.vue"
  }, null, _parent));
  _push(`<h2 id="animation-parameters" tabindex="-1">Animation Parameters <a class="header-anchor" href="#animation-parameters" aria-label="Permalink to &quot;Animation Parameters&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<script setup lang="ts">
import tokens from './theme.json';
import { snakeCase } from '@aurora/utils';
...
`,
    path: "en/features/tokens/demos/transition--no-code.vue"
  }, null, _parent));
  _push(`</div>`);
}
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("en/features/tokens/doc.md");
