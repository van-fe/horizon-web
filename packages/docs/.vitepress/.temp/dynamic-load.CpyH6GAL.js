        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_h_col, { span: 6 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title" data-v-0a27bdd1${_scopeId2}>单选</div>`);
            ...
            _push2(ssrRenderComponent(_component_h_col, { span: 6 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title" data-v-0a27bdd1${_scopeId2}>多选</div>`);
                  _push3(ssrRenderComponent(_component_h_tree_select, {
                    "tree-data": dynamicTreeData.value,
                    "onUpdate:treeData": ($event) => dynamicTreeData.value = $event,
                    "dynamic-load-data": dynLoad,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/TreeSelect/dynamic-load.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const dynamicLoad = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0a27bdd1"]]);
export {
