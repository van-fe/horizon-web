          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_h_col, { span: 8 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title" data-v-0aee0ac0${_scopeId2}>medium(default)</div>`);
                  _push3(ssrRenderComponent(_component_h_radio_button, {
                  ...
                  return [
                    ...
                    createVNode(_component_h_radio_button, {
                      modelValue: radio.value,
                      "onUpdate:modelValue": ($event) => radio.value = $event,
                      value: 1,
                      class: "radio",
            ...
            _push2(ssrRenderComponent(_component_h_col, { span: 8 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title" data-v-0aee0ac0${_scopeId2}>large</div>`);
                  _push3(ssrRenderComponent(_component_h_radio_button, {
                    modelValue: radio.value,
                    "onUpdate:modelValue": ($event) => radio.value = $event,
                    value: 1,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Radio/button.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const button = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0aee0ac0"]]);
export {
  button as default
};
