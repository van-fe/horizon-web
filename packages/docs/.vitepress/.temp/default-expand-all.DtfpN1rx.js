              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    ...
                    baseTreeData.value.length ? (openBlock(), createBlock(_component_h_tree_select, {
                      key: 0,
                      "tree-data": baseTreeData.value,
                      "is-default-expand-all": true,
                      "max-height": 300,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/TreeSelect/default-expand-all.vue");
