...
`,
  ...
  _push(`<h2 id="design-token" tabindex="-1">Design Token <a class="header-anchor" href="#design-token" aria-label="Permalink to &quot;Design Token&quot;">​</a></h2><table class="md-table"><thead><tr><th>Variable</th><th>Default Value</th><th>Description</th></tr></thead><tbody><tr><td>--n-space--small</td><td>var(--n-spacing-3)</td><td>small size spacing</td></tr><tr><td>--n-space--medium</td><td>var(--n-spacing-5)</td><td>medium size spacing</td></tr><tr><td>--n-space--large</td><td>var(--n-spacing-7)</td><td>large size spacing</td></tr><tr><td>--n-space--horizontal--small</td><td>var(--n-space--small)</td><td>horizontal small spacing</td></tr><tr><td>--n-space--horizontal--medium</td><td>var(--n-space--medium)</td><td>horizontal medium spacing</td></tr><tr><td>--n-space--horizontal--large</td><td>var(--n-space--large)</td><td>horizontal large spacing</td></tr><tr><td>--n-space--vertical--small</td><td>var(--n-space--small)</td><td>vertical small spacing</td></tr><tr><td>--n-space--vertical--medium</td><td>var(--n-space--medium)</td><td>vertical medium spacing</td></tr><tr><td>--n-space--vertical--large</td><td>var(--n-space--large)</td><td>vertical large spacing</td></tr><tr><td>--n-space--wrap--small</td><td>var(--n-space--vertical--small) var(--n-space--vertical--small)</td><td>wrap small spacing up down left right</td></tr><tr><td>--n-space--wrap--medium</td><td>var(--n-space--vertical--medium) var(--n-space--vertical--medium)</td><td>wrap medium spacing up down left right</td></tr><tr><td>--n-space--wrap--large</td><td>var(--n-space--vertical--large) var(--n-space--vertical--large)</td><td>wrap large spacing up down left right</td></tr></tbody></table><h2>Space Api</h2><h3>Space Props</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">block</td><td>将宽度调整为父元素宽度</td><td><code>boolean</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">align</td><td>对齐方式</td><td><code>&#39;start&#39; | &#39;end&#39; | &#39;center&#39; | &#39;baseline&#39;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">size</td><td>间距大小</td><td><code>| HApplicationSizeType<br>  | number<br>  | string<br>  | [number, number]<br>  | [string, string]</code></td><td class="text-center">No</td><td>&#39;medium&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">direction</td><td>间距方向</td><td><code>&#39;horizontal&#39; | &#39;vertical&#39;</code></td><td class="text-center">No</td><td>&#39;horizontal&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">wrap</td><td>是否换行，仅在 <code>type=horizontal</code> 时有效</td><td><code>boolean</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">fragment</td><td>是否转化 Fragment 节点列表</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">separator</td><td>启用分隔符</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr></tbody></table><h2>SpaceItem Api</h2><h3>SpaceItem Props</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">class</td><td></td><td><code>string | array</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">style</td><td></td><td><code>StyleValue</code></td><td class="text-center">No</td><td></td></tr></tbody></table></div>`);
}
