...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_h_button, mergeProps({ onClick: _ctx.del }, _attrs, ssrGetDirectiveProps(_ctx, _directive_popconfirm)), {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/directives/v-popconfirm/basic.vue");
