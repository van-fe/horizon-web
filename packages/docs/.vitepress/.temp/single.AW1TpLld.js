import { defineComponent, ref, resolveComponent, withCtx, createBlock, openBlock, Fragment, renderList, createVNode, unref, useSSRContext } from "vue/dist/vue.esm-bundler.js";
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_h_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title"${_scopeId2}>默认单选</div>`);
                  ...
                  return [
                    createVNode("div", { class: "demo-title" }, "默认单选"),
            ...
            _push2(ssrRenderComponent(_component_h_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title"${_scopeId2}>有选中标识</div>`);
                  _push3(ssrRenderComponent(_component_h_select, {
                  ...
                  return [
                    createVNode("div", { class: "demo-title" }, "有选中标识"),
                    createVNode(_component_h_select, {
                      modelValue: value2.value,
                      "onUpdate:modelValue": ($event) => value2.value = $event,
                      "show-selected-icon": true,
            ...
            _push2(ssrRenderComponent(_component_h_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="demo-title"${_scopeId2}>自定义选中标识</div>`);
                  _push3(ssrRenderComponent(_component_h_select, {
                    modelValue: value3.value,
                    "onUpdate:modelValue": ($event) => value3.value = $event,
                    "show-selected-icon": true,
                    "selected-icon": unref(__default__),
                    "to-body": false
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  return [
                    createVNode("div", { class: "demo-title" }, "自定义选中标识"),
                    createVNode(_component_h_select, {
                      modelValue: value3.value,
                      "onUpdate:modelValue": ($event) => value3.value = $event,
                      "show-selected-icon": true,
                      ...
                      _: 1
                    }, 8, ["modelValue", "onUpdate:modelValue", "selected-icon"])
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Select/single.vue");
