...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "colors" }, _attrs))} data-v-586bd7ab><!--[-->`);
      ssrRenderList(unref(elementListTokens).spacing, (token) => {
        _push(`<div class="color" data-v-586bd7ab><div class="label" data-v-586bd7ab><div class="key" data-v-586bd7ab>${ssrInterpolate(token.refToken)} `);
        _push(ssrRenderComponent(_component_copy_btn, {
          text: token.refToken
        }, null, _parent));
        _push(`</div></div><div class="value" data-v-586bd7ab>${ssrInterpolate(token.value)}</div></div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const spacing_NoCode = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-586bd7ab"]]);
export {
