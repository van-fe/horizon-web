...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"demos/components/Transfer.md","filePath":"zh/demos/components/Transfer.md"}');
const _sfc_main = { name: "demos/components/Transfer.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_demo_block = resolveComponent("demo-block");
  const _component_deprecated_tips = resolveComponent("deprecated-tips");
  _push(`<div${ssrRenderAttrs(_attrs)}><h1>Transfer</h1><p class="description"></p><h2 id="基本用法" tabindex="-1">基本用法 <a class="header-anchor" href="#基本用法" aria-label="Permalink to &quot;基本用法&quot;">​</a></h2>`);
  ...
  _push(`<h2 id="分类" tabindex="-1">分类 <a class="header-anchor" href="#分类" aria-label="Permalink to &quot;分类&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
...
`,
  ...
  _push(`<h2 id="单选" tabindex="-1">单选 <a class="header-anchor" href="#单选" aria-label="Permalink to &quot;单选&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-transfer
    v-model="dataModel"
...
`,
  ...
  _push(`<h2 id="选择人员" tabindex="-1">选择人员 <a class="header-anchor" href="#选择人员" aria-label="Permalink to &quot;选择人员&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-transfer
    v-model="dataModel"
...
`,
  ...
  _push(`<h2 id="选择组织架构" tabindex="-1">选择组织架构 <a class="header-anchor" href="#选择组织架构" aria-label="Permalink to &quot;选择组织架构&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <div>
...
`,
  ...
  _push(`<h2 id="可拖拽" tabindex="-1">可拖拽 <a class="header-anchor" href="#可拖拽" aria-label="Permalink to &quot;可拖拽&quot;">​</a></h2>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: '<template>\n  <h-transfer v-model="dataModel" :data="data" draggable style="width: 500px"></h-transfer>\n</template>\n\n<script lang="ts">\nimport { defineComponent, ref } from \'vue\';\nexport default defineComponent({\n  setup() {\n    const data = ref([]);\n    for (let i = 1; i <= 5; i++) {\n      data.value.push({\n        key: i,\n        label: `选项名称 ${i}`,\n      });\n    }\n    const dataModel = ref([]);\n    return {\n      data,\n      dataModel,\n    };\n  },\n});\n<\/script>\n',
    path: "demos/components/Transfer/drag.vue"
  }, null, _parent));
  _push(`<h2 id="transfer-api" class="no-underline h2"><a href="#transfer-api" class="!no-underline">Transfer Api</a></h2><h3 id="transfer-props" class="no-underline h3"><a href="#transfer-props" class="!no-underline">Transfer Props</a></h3><table class="md-table"><thead><tr><th>属性</th><th>说明</th><th>类型</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">必填</th><th>默认值</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">data</td><td>Transfer 的数据源</td><td><code>TransferDataProps[]</code></td><td class="text-center">是</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">v-model</td><td>绑定的key值</td><td><code>CheckboxUnionType[]</code></td><td class="text-center">否</td><td>() =&gt; []</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">disabled</td><td>是否禁用</td><td><code>boolean</code></td><td class="text-center">否</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">type`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "" }, null, _parent));
  _push(`</td><td>类型</td><td><code>&#39;normal&#39; | &#39;work&#39; | &#39;table&#39;</code></td><td class="text-center">否</td><td>&#39;normal&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">titles</td><td>自定义列表标题</td><td><code>string[]</code></td><td class="text-center">否</td><td>() =&gt; [&#39;全选&#39;, &#39;&#39;]</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">filterable</td><td>展示搜索框</td><td><code>boolean | ((value: string, item: TransferDataProps) =&gt; boolean)</code></td><td class="text-center">否</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">placeholder</td><td>搜索框占位符</td><td><code>string</code></td><td class="text-center">否</td><td>&#39;&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">filter-method</td><td>自定义搜索方法</td><td><code>(inputValue: string, item: TransferDataProps) =&gt; boolean</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">props</td><td>数据源的字段别名</td><td><code>Partial&lt;Record&lt;keyof TransferDataProps, keyof TransferDataProps | string&gt;&gt;</code></td><td class="text-center">否</td><td>() =&gt; {<br>      return {<br>        key: &#39;key&#39;,<br>        label: &#39;label&#39;,<br>        disabled: &#39;disabled&#39;,<br>        checked: &#39;checked&#39;,<br>        children: &#39;children&#39;,<br>        isGroup: &#39;isGroup&#39;,<br>      };<br>    }</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">empty-txt</td><td>空数据文本</td><td><code>string[]</code></td><td class="text-center">否</td><td>[&#39;暂无数据&#39;, &#39;暂无数据&#39;]</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">breadcrumb</td><td>面包屑默认标题</td><td><code>string</code></td><td class="text-center">否</td><td>&#39;HIO&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">target-order</td><td>右侧列表元素的排序策略: 若为 original，则保持与数据源相同的顺序； 若为 push，则新加入的元素排在最后； 若为 unshift，则新加入的元素排在最前</td><td><code>&#39;original&#39; | &#39;push&#39; | &#39;unshift&#39;</code></td><td class="text-center">否</td><td>&#39;push&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">field-map</td><td>options 字段映射，给定一个字段映射规则以达到在 option 中覆盖默认指定字段名称的目的</td><td><code>Partial&lt;Record&lt;keyof TransferDataProps, keyof TransferDataProps | string&gt;&gt;</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">draggable</td><td>是否可拖拽</td><td><code>boolean</code></td><td class="text-center">否</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">on-drag-over</td><td>节点被拖拽至可释放目标上时的回调</td><td><code>(e: DragEvent, item: TransferDataProps) =&gt; void</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">on-drag-start</td><td>节点开始拖拽的回调</td><td><code>(e: DragEvent, item: TransferDataProps) =&gt; void</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">on-drag-end</td><td>节点结束拖拽的回调</td><td><code>(e: DragEvent, item: TransferDataProps) =&gt; void</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">on-drag-leave</td><td>节点离开可释放目标上时的回调</td><td><code>(e: DragEvent, item: TransferDataProps) =&gt; void</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">on-drop</td><td>节点在可释放目标上释放时的回调</td><td><code>(e: DragEvent, dropItem: TransferDataProps, dragItem: TransferDataProps) =&gt; void</code></td><td class="text-center">否</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">work-input-fn`);
  _push(ssrRenderComponent(_component_deprecated_tips, { name: "<code>filterable</code>" }, null, _parent));
  _push(`</td><td>work类型输入回调，具有过滤功能</td><td><code>(item: any, input: string) =&gt; boolean</code></td><td class="text-center">否</td><td></td></tr></tbody></table><h3 id="transfer-emits" class="no-underline h3"><a href="#transfer-emits" class="!no-underline">Transfer Emits</a></h3><table class="md-table"><thead><tr><th>属性</th><th>说明</th><th>类型</th><th>参数名</th><th>参数类型</th><th>参数说明</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">blur</td><td rowspan="1">失焦时触发</td><td rowspan="1">( evt: <code>FocusEvent</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">evt</td><td><code>FocusEvent</code></td><td>失焦事件</td></tr><tr><td rowspan="3" style="${ssrRenderStyle({ "word-break": "keep-all" })}">change</td><td rowspan="3">选项在两栏之间转移时触发</td><td rowspan="3">( targetKeys: <code>CheckboxUnionType[]</code>, direction: <code>&#39;left&#39; | &#39;right&#39;</code>, moveKeys: <code>CheckboxUnionType[]</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">targetKeys</td><td><code>CheckboxUnionType[]</code></td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">direction</td><td><code>&#39;left&#39; | &#39;right&#39;</code></td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">moveKeys</td><td><code>CheckboxUnionType[]</code></td><td></td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">left-check-change</td><td rowspan="1">left栏选中项发生变化时触发</td><td rowspan="1">( value: <code>CheckboxUnionType[]</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">value</td><td><code>CheckboxUnionType[]</code></td><td>选中key值</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">right-check-change</td><td rowspan="1">right栏选中项发生变化时触发</td><td rowspan="1">( value: <code>CheckboxUnionType[]</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">value</td><td><code>CheckboxUnionType[]</code></td><td>选中key值</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">search</td><td rowspan="1">搜索框内容时改变时触发</td><td rowspan="1">( value: <code>string</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">value</td><td><code>string</code></td><td>搜索框内容</td></tr></tbody></table></div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("zh/demos/components/Transfer.md");
