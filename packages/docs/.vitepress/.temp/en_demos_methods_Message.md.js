...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><h1>Message</h1><p class="description">By calling the <code>$message</code> method, the default close time is 3s.</p><h2 id="basic" tabindex="-1">Basic <a class="header-anchor" href="#basic" aria-label="Permalink to &quot;Basic&quot;">​</a></h2><p>By calling the <code>$message</code> method, the default close time is 3s.</p>`);
...
`,
  ...
  _push(`<h3 id="message-options" class="no-underline h3"><a href="#message-options" class="!no-underline">Message Options</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>是否Required</th><th>Default</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">message</td><td rowspan="1">Message文字</td><td rowspan="1">Yes</td><td rowspan="1">-</td><td rowspan="1"><code> string | VNode</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">type</td><td rowspan="1">Messagetype</td><td rowspan="1">No</td><td rowspan="1">&#39;info&#39;</td><td rowspan="1"><code> &#39;success&#39; | &#39;info&#39; | &#39;warning&#39; | &#39;error&#39; | &#39;loading&#39;</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">useHTMLString</td><td rowspan="1">Whether 将 message props作为 HTML 片段处理</td><td rowspan="1">No</td><td rowspan="1">false</td><td rowspan="1"><code> boolean</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">duration</td><td rowspan="1">Display time, in milliseconds Set 为 0 时不会automaticallyclose</td><td rowspan="1">No</td><td rowspan="1">3000</td><td rowspan="1"><code> number</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">showClose</td><td rowspan="1">Whether Display closebutton</td><td rowspan="1">No</td><td rowspan="1">false</td><td rowspan="1"><code> boolean</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">offset</td><td rowspan="1">Message distancewindowtop的offset量</td><td rowspan="1">No</td><td rowspan="1">32</td><td rowspan="1"><code> number</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">zIndex</td><td rowspan="1">Message文字</td><td rowspan="1">No</td><td rowspan="1">-</td><td rowspan="1"><code> number</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">onClose</td><td rowspan="1">Callback invoked when the message closes</td><td rowspan="1">No</td><td rowspan="1">-</td><td rowspan="1"><code> (vm: VNode) =&gt; void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">vm</td><td><code>VNode</code></td><td>-</td></tr></tbody></table><h3 id="message-methods" class="no-underline h3"><a href="#message-methods" class="!no-underline">Message Methods</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">closeAll</td><td rowspan="1">Closeallmessage</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">success</td><td rowspan="1">Successmessage</td><td rowspan="1">( options: <code>Partial&lt;ExtractMethodOptions&lt;string | MessageOriginOption&gt;&gt;</code> ) =&gt; <code>Pick&lt;IMessageInstance, &#39;close&#39;&gt;</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">options</td><td><code>Partial&lt;ExtractMethodOptions&lt;string | MessageOriginOption&gt;&gt;</code></td><td>Message的消息文字, 或者 MessageOriginOption 选项</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">warning</td><td rowspan="1">Warningmessage</td><td rowspan="1">( options: <code>Partial&lt;ExtractMethodOptions&lt;string | MessageOriginOption&gt;&gt;</code> ) =&gt; <code>Pick&lt;IMessageInstance, &#39;close&#39;&gt;</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">options</td><td><code>Partial&lt;ExtractMethodOptions&lt;string | MessageOriginOption&gt;&gt;</code></td><td>Message text or a MessageOriginOption object</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">error</td><td rowspan="1">Errormessage</td><td rowspan="1">( options: <code>Partial&lt;ExtractMethodOptions&lt;string | MessageOriginOption&gt;&gt;</code> ) =&gt; <code>Pick&lt;IMessageInstance, &#39;close&#39;&gt;</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">options</td><td><code>Partial&lt;ExtractMethodOptions&lt;string | MessageOriginOption&gt;&gt;</code></td><td>Message text or a MessageOriginOption object</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">info</td><td rowspan="1">Messagemessage</td><td rowspan="1">( options: <code>Partial&lt;ExtractMethodOptions&lt;string | MessageOriginOption&gt;&gt;</code> ) =&gt; <code>Pick&lt;IMessageInstance, &#39;close&#39;&gt;</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">options</td><td><code>Partial&lt;ExtractMethodOptions&lt;string | MessageOriginOption&gt;&gt;</code></td><td>Message text or a MessageOriginOption object</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">loading</td><td rowspan="1">Show a pending message that can be closed asynchronously</td><td rowspan="1">( options: <code>Partial&lt;ExtractMethodOptions&lt;string | MessageOriginOption&gt;&gt;</code> ) =&gt; <code>IMessageInstance</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">options</td><td><code>Partial&lt;ExtractMethodOptions&lt;string | MessageOriginOption&gt;&gt;</code></td><td>提示的消息文字，或者 <code>MessageOriginOption</code> 选项</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">config</td><td rowspan="1">Configure global settings, including the maximum number of displayed messages</td><td rowspan="1">( options: <code>Partial&lt;ExtractMethodOptions&lt;{ maxCount: number; duration: number }&gt;&gt;</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">options</td><td><code>Partial&lt;ExtractMethodOptions&lt;{ maxCount: number; duration: number }&gt;&gt;</code></td><td>Global message configuration</td></tr></tbody></table></div>`);
}
