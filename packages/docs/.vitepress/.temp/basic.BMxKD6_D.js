    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        ssrRenderList(20, (item) => {
          _push2(`<div class="item" data-v-5544c0aa${_scopeId}>${ssrInterpolate(item)}</div>`);
        });
        _push2(`<!--]-->`);
      } else {
        return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Scrollbar/basic.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const basic = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-5544c0aa"]]);
export {
  basic as default
};
