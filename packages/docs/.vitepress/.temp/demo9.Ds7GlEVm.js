...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const collapseUpdateHandle = (collapse) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "wrapper" }, _attrs))} data-v-ea3a126a>`);
      _push(ssrRenderComponent(_component_h_anchor, {
        "scroll-container": unref(scrollContainer),
        "link-target": "_top",
        "use-collapse": true,
        "onUpdate:collapse": collapseUpdateHandle
      }, {
      ...
      _push(`<div class="split" data-v-ea3a126a></div>`);
      _push(ssrRenderComponent(_component_h_anchor, {
        "scroll-container": unref(scrollContainer),
        "link-target": "_top",
        "use-collapse": true,
        "collapse-text": "展开全部内容",
        "onUpdate:collapse": collapseUpdateHandle
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Anchor/demo9.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const demo9 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ea3a126a"]]);
export {
  demo9 as default
};
