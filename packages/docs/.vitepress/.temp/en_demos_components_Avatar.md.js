...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"en/demos/components/Avatar.md","filePath":"en/demos/components/Avatar.md"}');
const _sfc_main = { name: "en/demos/components/Avatar.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("en/demos/components/Avatar.md");
