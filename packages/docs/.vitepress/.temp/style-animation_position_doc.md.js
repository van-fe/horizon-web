...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_demo_block, {
    ...
    path: "zh/style-animation/position/demos/demo1.vue"
  }, null, _parent));
  _push(`</div>`);
}
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("zh/style-animation/position/doc.md");
