...
`,
  ...
  _push(`<h2>Anchor Api</h2><h3>Anchor Props</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">size</td><td>组件尺寸<br><br>medium：文字14px，导航整体宽度140px。距上24px，距左32px<br>small：文字12px，导航整体宽度120px。距上24px，距左32px</td><td><code>&#39;medium&#39; | &#39;small&#39;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">max-height</td><td>导航容器的最大高度，超出时会显示滚动条（优先级较高，单位为“px”，不包含margin）</td><td><code>number</code></td><td class="text-center">No</td><td>750</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">change-hash</td><td>是否改变 <code>hash</code></td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">scroll-container</td><td>指定滚动容器</td><td><code>string | HTMLElement | Window</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">scroll-behavior</td><td>滚动行为的“平滑程度”（和 MDN文档 保持一致）</td><td><code>&#39;smooth&#39; | &#39;auto&#39;</code></td><td class="text-center">No</td><td>&#39;smooth&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">scroll-offset</td><td>滚动的偏移量。即文档滚动结束时，锚点距离“滚动容器”顶部的距离。<br>该值的Type为<code>number</code>时，单位固定为“px”，相对于“滚动容器”的顶部。（默认为：&#39;start&#39;，即 0 ）</td><td><code>&#39;start&#39; | &#39;center&#39; | &#39;end&#39; | number</code></td><td class="text-center">No</td><td>&#39;start&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">bounds-offset</td><td>锚点区域边界的偏移量。即滚动内容距离“滚动容器”顶部达到指定偏移量时触发“当前高亮的Link”改变。<br>该值的Type为<code>number</code>时，单位固定为“px”，相对于“滚动容器”的顶部。（默认为：5 ）</td><td><code>&#39;start&#39; | &#39;center&#39; | &#39;end&#39; | number</code></td><td class="text-center">No</td><td>5</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">use-collapse</td><td>是否开启折叠模式</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">collapse</td><td>默认的折叠状态（仅在折叠模式下生效，默认处于非折叠状态）</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">collapse-text</td><td>收起时的提示文本<br>默认使用国际化</td><td><code>string | VNode</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">show-line</td><td>是否显示左侧边线</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">show-highlight-line</td><td>是否显示左侧边线上的“高亮”部分</td><td><code>boolean</code></td><td class="text-center">No</td><td>true</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">show-title-suffix</td><td>一级导航的“title”末尾是否展示数字后缀（表示其下面的二级导航的总个数）</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">placement</td><td>Tooltip的弹出方向（导航title溢出打点展示时，若处于hover状态则会弹出）</td><td><code>&#39;top-start&#39; | &#39;top-end&#39; | &#39;bottom-start&#39; | &#39;bottom-end&#39; | &#39;top&#39; | &#39;bottom&#39; | &#39;right&#39; | &#39;left&#39;</code></td><td class="text-center">No</td><td>&#39;left&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">style</td><td>导航容器的样式对象（Anchor组件的默认定位方式为<code>relative</code>，通过该Name可自定义它的定位方式）</td><td><code>CSSProperties</code></td><td class="text-center">No</td><td>() =&gt; ({})</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">auto-render</td><td>是否开启“自动渲染”模式</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">auto-render-rules</td><td>自动渲染规则（数组索引表示导航级别，默认支持6级，也支持无限叠加）<br>各级规则可以配置为字符串数组（该处的字符串实则为“CSS选择器”），例如: [[&#39;h1&#39;, &#39;h2&#39;], &#39;h3&#39;, &#39;h4&#39;, &#39;h5&#39;]</td><td><code>(string | string[])[]</code></td><td class="text-center">No</td><td>() =&gt; [&#39;h1&#39;, &#39;h2&#39;, &#39;h3&#39;, &#39;h4&#39;, &#39;h5&#39;, &#39;h6&#39;]</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">link-target</td><td>可以覆盖 <code>n-anchor-link</code> 的 <code>target</code></td><td><code>&#39;_self&#39; | &#39;_blank&#39; | &#39;_parent&#39; | &#39;_top&#39;</code></td><td class="text-center">No</td><td></td></tr></tbody></table><h3>Anchor Emits</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="2" style="${ssrRenderStyle({ "word-break": "keep-all" })}">click</td><td rowspan="2">click事件</td><td rowspan="2">( linkInfo: <code>{ href: string; title: string }</code>, e: <code>MouseEvent</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">linkInfo</td><td><code>{ href: string; title: string }</code></td><td>被点击的锚点的相关信息（子Name<code>href</code>和<code>title</code>均为使用组件时传递的Name）</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">e</td><td><code>MouseEvent</code></td><td>原生的点击事件对象</td></tr><tr><td rowspan="2" style="${ssrRenderStyle({ "word-break": "keep-all" })}">change</td><td rowspan="2">change事件</td><td rowspan="2">( link: <code>string</code>, prevLink: <code>string</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">link</td><td><code>string</code></td><td>改变之后的锚点href</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">prevLink</td><td><code>string</code></td><td>改变之前的锚点href</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">update:collapse</td><td rowspan="1">collapse 改变后的通知</td><td rowspan="1">( collapse: <code>boolean</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">collapse</td><td><code>boolean</code></td><td>改变之后是否为“折叠”状态</td></tr></tbody></table><h3>Anchor Exposes</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Input/Output</th><th>Input/Output Type</th><th>Input/Output Description</th></tr></thead><tbody><tr><td rowspan="2" style="${ssrRenderStyle({ "word-break": "keep-all" })}">updateActiveLink</td><td rowspan="2">更新当前活动的链接</td><td rowspan="2">( link: <code>string</code>, needScroll: <code>boolean</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">link</td><td><code>string</code></td><td>当前锚点</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">needScroll</td><td><code>boolean</code></td><td>是否需要滚动到对应位置</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">refreshAnchorList</td><td rowspan="1">重新获取锚点节点（用于在“自动渲染”模式下重新获取锚点节点）</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">updateScrollContainer</td><td rowspan="1">重新获取 <code>props.scrollContainer</code> 所标记的对象<br>仅对于 <code>props.scrollContainer</code> 是字符串时需要使用，且如果 <code>anchor</code> 挂载早于 <code>props.scrollContainer</code> 时，则需要使用此方法重新获取</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">getAnchorList</td><td rowspan="1">获取锚点列表<br>在使用自动渲染时，可以使用这个方法获取锚点节点列表</td><td rowspan="1">( ) =&gt; <code>AnchorListItem[]</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">default</td><td><code>AnchorListItem</code></td><td>AnchorListItem 锚点节点列表</td></tr></tbody></table><h2>AnchorLink Api</h2><h3>AnchorLink Props</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">title</td><td>描述内容</td><td><code>string</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">href</td><td>锚点链接</td><td><code>string</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">target</td><td>该Name指定在何处显示链接的资源（和 MDN文档 保持一致）</td><td><code>&#39;_self&#39; | &#39;_blank&#39; | &#39;_parent&#39; | &#39;_top&#39;</code></td><td class="text-center">No</td><td>&#39;_self&#39;</td></tr></tbody></table></div>`);
}
