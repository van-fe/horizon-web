...
`,
  ...
  _push(`<h2 id="use-with-form" tabindex="-1">Use with Form <a class="header-anchor" href="#use-with-form" aria-label="Permalink to &quot;Use with Form&quot;">​</a></h2><p>You can enable the <code>form</code> attribute to adapt to the <code>n-form</code> component</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
...
`,
  ...
  _push(`<h2>Segmented Api</h2><h3>Segmented Props</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">active-key</td><td>当前激活的选项，可使用 <code>v-model:active-key</code> 绑定<br>特别Description：undefined、null 值均会当成空值处理</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">default-active-key</td><td>默认激活的选项，优先级低于 <code>activeKey</code>，当 <code>defaultActiveKey</code> 和 <code>activeKey</code> 均不存在时候，第一个选项激活<br>特别Description：undefined、null 值均会当成空值处理</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">size</td><td>Segmented 尺寸大小</td><td><code>&#39;small&#39; | &#39;medium&#39; | &#39;large&#39; | &#39;huge&#39;</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">scrollable</td><td>当元素过多时候，可滑动</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">focusable</td><td>当元素选中时候，否滑动到目标元素</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">arrow</td><td>当超长的时候，是否使用箭头</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">block</td><td>使其适应父级宽度</td><td><code>boolean</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">form</td><td>是否启用表单模式，以适配 <code>n-form</code> 组件</td><td><code>boolean</code></td><td class="text-center">No</td><td></td></tr></tbody></table><h3>Segmented Emits</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">update:active-key</td><td rowspan="1">更新 activeKey</td><td rowspan="1">( key: <code>HSegmentedValue</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">key</td><td><code>HSegmentedValue</code></td><td></td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">change</td><td rowspan="1">选项卡变化回调</td><td rowspan="1">( key: <code>HSegmentedValue</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">key</td><td><code>HSegmentedValue</code></td><td></td></tr></tbody></table><h2>SegmentedItem Api</h2><h3>SegmentedItem Props</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">label</td><td>名称，值使用 <code>key</code></td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">icon</td><td>图标名字，为空表示没有图标</td><td><code>string</code></td><td class="text-center">No</td><td>&#39;&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">icon-size</td><td>图标大小</td><td><code>string | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">disabled</td><td>是否禁用</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr></tbody></table><h3>SegmentedItem Emits</h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">click</td><td rowspan="1">点击触发点击事件</td><td rowspan="1">( key: <code>HSegmentedValue</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">key</td><td><code>HSegmentedValue</code></td><td></td></tr></tbody></table></div>`);
}
