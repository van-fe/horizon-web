...
`,
  ...
  _push(`<h2 id="watermark-api" class="no-underline h2"><a href="#watermark-api" class="!no-underline">Watermark Api</a></h2><h3 id="watermark-props" class="no-underline h3"><a href="#watermark-props" class="!no-underline">Watermark Props</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">global</td><td>Configuration for global.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">container</td><td>Configuration for container.</td><td><code>HTMLElement</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">content</td><td>Configuration for content.</td><td><code>string | string[]</code></td><td class="text-center">No</td><td>&#39;watermark&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">image</td><td>Configuration for image.</td><td><code>string</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">width</td><td>Configuration for width.</td><td><code>number</code></td><td class="text-center">No</td><td>120</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">height</td><td>Configuration for height.</td><td><code>number</code></td><td class="text-center">No</td><td>64</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">rotate</td><td>Configuration for rotate.</td><td><code>number</code></td><td class="text-center">No</td><td>-15</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">z-index</td><td>Configuration for z index.</td><td><code>number</code></td><td class="text-center">No</td><td>99999</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">content-style</td><td>Configuration for content style.</td><td><code>WatermarkContentStyle</code></td><td class="text-center">No</td><td>() =&gt; ({<br>      fontStyle: &#39;normal&#39;,<br>      fontVariant: &#39;normal&#39;,<br>      fontWeight: &#39;normal&#39;,<br>      fontSize: 16,<br>      fontFamily: &#39;sans-serif&#39;,<br>      color: &#39;rgba(115, 117, 122, 1)&#39;,<br>    })</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">line-gap</td><td>Configuration for line gap.</td><td><code>number</code></td><td class="text-center">No</td><td>5</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">gap</td><td>Configuration for gap.</td><td><code>[number, number]</code></td><td class="text-center">No</td><td>() =&gt; [100, 60]</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">offset</td><td>Configuration for offset.</td><td><code>[number, number]</code></td><td class="text-center">No</td><td>() =&gt; [0, 0]</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">opacity</td><td>Configuration for opacity.</td><td><code>number</code></td><td class="text-center">No</td><td>0.1</td></tr></tbody></table><h3 id="watermark-emits" class="no-underline h3"><a href="#watermark-emits" class="!no-underline">Watermark Emits</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">tampered</td><td rowspan="1">Emitted when tampered changes.</td><td rowspan="1">( ) =&gt; <code>void</code></td><td>-</td><td>-</td><td>-</td></tr></tbody></table></div>`);
}
