...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-8d38b458><div class="container" data-v-8d38b458><div class="container__block" data-v-8d38b458><div class="container__title" data-v-8d38b458> 添加描述信息 <div data-v-8d38b458>可根据节点内容，自定义节点文本内容；</div></div>`);
  ...
  _push(`</div><div class="container__block" data-v-8d38b458><div class="container__title" data-v-8d38b458> ⾃定义时间戳 <div data-v-8d38b458> 时间有三种排列方式：置顶、置右、置下 <br data-v-8d38b458> 可以将时间格式化 </div></div><div class="container" data-v-8d38b458>`);
  ...
  _push(`</div></div><div class="container__block" data-v-8d38b458><div class="container__title" data-v-8d38b458> 自定义时间顺序 <div data-v-8d38b458>可以按照时间顺序/逆序展示</div></div><div class="container" data-v-8d38b458>`);
  _push(ssrRenderComponent(_component_h_timeline, {
    sort: "order",
    first: { color: "var(--h-bg-brand-default)" }
  }, {
  ...
  _push(`</div></div></div><div class="container" data-v-8d38b458><div class="container__block" data-v-8d38b458><div class="container__title" data-v-8d38b458> 自定义节点样式 <div data-v-8d38b458>可根据实际业务情况，自定义节点内容，如错误、预警、成功签收等状态；</div></div><div class="container" data-v-8d38b458>`);
  _push(ssrRenderComponent(_component_h_timeline, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_h_timeline_item, {
  ...
  _push(`</div></div><div class="container__block" data-v-8d38b458><div class="container__title" data-v-8d38b458> 自定义节点内容 <div data-v-8d38b458>可根据实际业务情况，自定义节点内容，如内文、图片、回复等；</div></div>`);
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_h_timeline_item, {
          ...
          name: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div class="timeline-title-slot" data-v-8d38b458${_scopeId2}>`);
              _push3(ssrRenderComponent(_component_h_avatar, { size: "mini" }, null, _parent3, _scopeId2));
              _push3(`<div class="timeline-title-slot__name" data-v-8d38b458${_scopeId2}>Wanqi peng</div>`);
          ...
          desc: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div data-v-8d38b458${_scopeId2}> Demo installed its 700th battery swap station in China, <br data-v-8d38b458${_scopeId2}> hitting its annual target ahead of schedule. </div><div style="${ssrRenderStyle({ "display": "flex" })}" data-v-8d38b458${_scopeId2}>`);
        ...
        _push2(ssrRenderComponent(_component_h_timeline_item, {
          ...
          desc: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div data-v-8d38b458${_scopeId2}> Demo installed its 700th battery swap station in China, <br data-v-8d38b458${_scopeId2}> hitting its annual target ahead of schedule. </div>`);
            } else {
              return [
                createVNode("div", null, [
                  createTextVNode(" Demo installed its 700th battery swap station in China, "),
        ...
        _push2(ssrRenderComponent(_component_h_timeline_item, {
          ...
          name: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              _push3(`<div class="timeline-title-slot__action" data-v-8d38b458${_scopeId2}>Add follow-up note</div></div>`);
            } else {
              return [
                createVNode("div", { class: "timeline-title-slot" }, [
                  createVNode(_component_h_avatar, { size: "mini" }),
  ...
  _push(`</div><div class="container__block" data-v-8d38b458><div class="container__title" data-v-8d38b458> 表达步骤感的混合时间轴 <div data-v-8d38b458> 实线显示已发生的时间节点，虚线显示未发生的时间节点。一般已经发生的步骤再上，步骤过多，可折叠。 </div></div>`);
  _push(ssrRenderComponent(_component_h_timeline, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_h_timeline_item, {
...
const prop = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-8d38b458"]]);
export {
  prop as default
};
