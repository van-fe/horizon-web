...
`,
  ...
  _push(`<h2 id="按钮样式" tabindex="-1">按钮样式 <a class="header-anchor" href="#按钮样式" aria-label="Permalink to &quot;按钮样式&quot;">​</a></h2><p>只需要把<code>h-checkbox</code>元素换成<code>h-checkbox-button</code>元素即可，同时提供<code>size</code>属性控制大小</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-row align="middle">
    <h-col :span="6">
...
`,
  ...
  _push(`<h2 id="多选框组" tabindex="-1">多选框组 <a class="header-anchor" href="#多选框组" aria-label="Permalink to &quot;多选框组&quot;">​</a></h2><p>结合<code>h-checkbox-group</code>和<code>h-checkbox</code>或者<code>h-checkbox-button</code>可以实现复选框组</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
  <h-row>
    <h-col :span="24">
