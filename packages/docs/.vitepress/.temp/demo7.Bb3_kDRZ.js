...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_h_footer = resolveComponent("h-footer");
  _push(ssrRenderComponent(_component_h_container, mergeProps({ class: "common-container" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_h_aside, null, {
        ...
        _push2(ssrRenderComponent(_component_h_container, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_h_header, null, {
              ...
              _push3(ssrRenderComponent(_component_h_main, null, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`Main`);
                  } else {
              ...
              _push3(ssrRenderComponent(_component_h_footer, null, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`Footer`);
                  } else {
              ...
              return [
                ...
                createVNode(_component_h_footer, null, {
                  default: withCtx(() => [
                    createTextVNode("Footer")
                  ]),
                  _: 1
        ...
        return [
          createVNode(_component_h_aside, null, {
            default: withCtx(() => [
              createTextVNode("Aside")
            ]),
            _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Container/demo7.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const demo7 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-ea795cda"]]);
export {
  demo7 as default
};
