            ...
            if (_push3) {
              _push3(ssrRenderComponent(_component_h_cascader, {
                ...
                selectRender: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`你的选择是：${ssrInterpolate(_ctx.currentVal1.join("+"))}`);
                  } else {
                    return [
                      createTextVNode("你的选择是：" + toDisplayString(_ctx.currentVal1.join("+")), 1)
                    ];
                  }
                }),
                _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Cascader/custom-trigger-inner.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const customTriggerInner = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  customTriggerInner as default
};
