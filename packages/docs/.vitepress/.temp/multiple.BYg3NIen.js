...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function setSelected(ignoreSelectable = false) {
      var _a;
      (_a = selectionColumnDomRef.value) == null ? void 0 : _a.toggleRowSelection([4, 5], void 0, ignoreSelectable);
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><p> current picked indexes: ${ssrInterpolate(checkedRows.value)}</p>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(HTableColumn), {
              ...
              "selected-keys": checkedRows.value,
              "onUpdate:selectedKeys": ($event) => checkedRows.value = $event,
              type: "selection",
              multiple: true,
              align: "center",
              width: "40",
      ...
      _push(ssrRenderComponent(_component_h_button, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`toggle row ignore selectable`);
          } else {
            return [
              createTextVNode("toggle row ignore selectable")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_h_button, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`toggle row consider selectable`);
          } else {
            return [
              createTextVNode("toggle row consider selectable")
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("demos/components/Table/multiple.vue");
