...
`,
  ...
  _push(`<h2 id="和表单一起使用" tabindex="-1">和表单一起使用 <a class="header-anchor" href="#和表单一起使用" aria-label="Permalink to &quot;和表单一起使用&quot;">​</a></h2><p>可以通过启用 <code>form</code> 属性，以适配 <code>h-form</code> 组件</p>`);
  _push(ssrRenderComponent(_component_demo_block, {
    source: `<template>
