...
`,
  ...
  _push(`<h2 id="rate-api" class="no-underline h2"><a href="#rate-api" class="!no-underline">Rate Api</a></h2><h3 id="rate-props" class="no-underline h3"><a href="#rate-props" class="!no-underline">Rate Props</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th style="${ssrRenderStyle({ "min-width": "50px" })}" class="text-center">Required</th><th>Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">v-model</td><td>Configuration for model value.</td><td><code>number</code></td><td class="text-center">No</td><td>3</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">count</td><td>Configuration for count.</td><td><code>number</code></td><td class="text-center">No</td><td>5</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">half</td><td>Configuration for half.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">show-tooltip</td><td>Configuration for show tooltip.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">tooltip</td><td>Configuration for tooltip.</td><td><code>array</code></td><td class="text-center">No</td><td>[]</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">readonly</td><td>Configuration for readonly.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">disabled</td><td>Configuration for disabled.</td><td><code>boolean</code></td><td class="text-center">No</td><td>false</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">size</td><td>Configuration for size.</td><td><code>&#39;large&#39; | &#39;medium&#39; | &#39;small&#39; | number</code></td><td class="text-center">No</td><td></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">icon</td><td>Configuration for icon.</td><td><code>string</code></td><td class="text-center">No</td><td>&#39;star_filled&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">color</td><td>Configuration for color.</td><td><code>string</code></td><td class="text-center">No</td><td><code>rgb(\${cssVariable(&#39;rate-color--content&#39;)})</code></td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">void-color</td><td>Configuration for void color.</td><td><code>string</code></td><td class="text-center">No</td><td>cssVariable(&#39;border-default&#39;)</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">disabled-color</td><td>Configuration for disabled color.</td><td><code>string</code></td><td class="text-center">No</td><td>&#39;#9B9DA9&#39;</td></tr><tr><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">gutter</td><td>Configuration for gutter.</td><td><code>number</code></td><td class="text-center">No</td><td>5</td></tr></tbody></table><h3 id="rate-emits" class="no-underline h3"><a href="#rate-emits" class="!no-underline">Rate Emits</a></h3><table class="md-table"><thead><tr><th>Name</th><th>Description</th><th>Type</th><th>Parameter</th><th>Parameter Type</th><th>Parameter Description</th></tr></thead><tbody><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">change</td><td rowspan="1">Emitted when change changes.</td><td rowspan="1">( value: <code>number</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">value</td><td><code>number</code></td><td>The value value.</td></tr><tr><td rowspan="1" style="${ssrRenderStyle({ "word-break": "keep-all" })}">blur</td><td rowspan="1">Emitted when blur changes.</td><td rowspan="1">( evt: <code>FocusEvent</code> ) =&gt; <code>void</code></td><td style="${ssrRenderStyle({ "word-break": "keep-all" })}">evt</td><td><code>FocusEvent</code></td><td>The evt value.</td></tr></tbody></table></div>`);
}
