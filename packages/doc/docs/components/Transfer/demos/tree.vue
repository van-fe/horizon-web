<template>
  <div>
    ...
    >
      <template #item="{ item }">
        <div class="flex aligh-center overflow-hidden">
    ...
    <h-transfer-v-2 v-model="dataModel" :data="data" draggable style="width: 600px">
      <template #item="{ item, type }">
        <div v-if="type === 'left'" class="flex aligh-center overflow-hidden">
          <h-avatar size="small" :src="item.avatar" />
          <div class="ml-2 flex-1 flex flex-column overflow-hidden">
            <div style="text-overflow: ellipsis; overflow: hidden">{{ item.label }}</div>
            <div
        ...
        <div v-if="type === 'right'" class="flex aligh-center overflow-hidden">
          <h-avatar size="small" :src="item.avatar" />
          <div class="ml-2 flex-1 flex flex-column overflow-hidden">
            <div style="text-overflow: ellipsis; overflow: hidden">{{ item.label }}</div>
            <div
...
const originData = [
  {
    key: 0,
    label: '某某集团',
    avatar: 'https://cdh-app.nio.com/user/2022/3/1/61e23a30-bf79-4479-b084-27a36adb8334.jpg',
    children: [
      {
        key: '0-1',
        label: '某某公司',
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleSearch = (key: string, item: TransferDataProps) => {
      if (key === '') return true;
      if (item.label.includes(key)) return true;
      return false;
    };
    return {
      data,
