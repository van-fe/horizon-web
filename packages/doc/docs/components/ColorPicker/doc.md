...
注：网页取色使用了 [EyeDropper API](https://developer.mozilla.org/eh-US/docs/Web/API/EyeDropper)，但具体的浏览器支持情况需要查看：[Can I Use](https://caniuse.com/?search=EyeDropper)，在实际生产场景时，请谨慎使用此能力，此 `API` 并不精准，可能会有细微差距
:::demo ./demos/examples.vue :::
