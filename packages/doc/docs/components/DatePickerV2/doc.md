...
:::demo ./demos/first-day-of-week.vue :::

### 禁止切换年
如果不希望用户在日选择时左右切换年份，则设置 `show-year-button = false`
:::demo ./demos/show-year-button.vue :::

### 快捷选择
通过配置 `shortcuts` 配置快捷选择日期功能
:::demo ./demos/shortcuts.vue :::
...
:::demo ./demos/panel-show-date.vue :::
...
:::demo ./demos/format-trigger-text.vue :::

### 自定义日期格子内容
使用 `default` 插槽，可以自定义日期格子的内容
:::demo ./demos/default-slot.vue :::
