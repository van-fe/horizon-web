<template>
  ...
  <h-guide v-model="current" v-model:visible="visible" type="primary" @close="onClose" @finish="onFinish">
    ...
    <h-guide-item target=".guide-second" title="第二步" content="第二步就是第二步" placement="top-start" image="https://static.nio.com/fx-static/desigh-system/clgkp3u9z0002082h1dfr888x/indexbg.jpg?imageView2/2/w/300" />
