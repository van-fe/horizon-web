<template>
  <div class="container">
    <div style="display: flex; align-items: center">
      <n-checkbox-button class="checkbox-button" v-model="checked" @change="setTitle">Set Title</n-checkbox-button>
      <n-checkbox-button class="checkbox-button" v-model="border">Border</n-checkbox-button>
      <div>Type：</div>
...
export default defineComponent({
  setup() {
    ...
    const sizeOptions = ref(['small', 'medium']);
    const title = ref('');
