  ...
  >
    <h-form-item label="input style" prop="inputStyle">
      <h-radio-group v-model="formData.inputStyle" size="medium">
        <h-radio v-for="item in ['normal', 'no-border']" :key="item" :label="item" />
      </h-radio-group>
    </h-form-item>
    ...
    <h-form-item label="Province" prop="province" tip="Please pick your province">
      <h-select v-model="formData.province" :input-style="formData.inputStyle" placeholder="Please select">
        ...
        <h-option label="Wuhan" value="wuhan" />
      </h-select>
    </h-form-item>
