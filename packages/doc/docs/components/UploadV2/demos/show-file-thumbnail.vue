<template>
  <n-switch
    v-model="showFileThumbnail"
    status
    status-on-text="show thumbnail"
...
const modelValue = ref<NUploadUserFile[]>(
  [
    {
      name: 'background.jpg',
      url: 'https://cdn-public-dev.nio.com/aurora-resource/5cBiDhad9L9aZ3nAml1m8/23244a6b-69c3-4465-bbd6-5db4b476abf4.jpg',
    },
    {
      name: 'success.png',
