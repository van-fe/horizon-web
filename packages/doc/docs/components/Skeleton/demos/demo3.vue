  ...
  <section class="main">
    <h-skeleton :loading="isLoading">
      <template #loadingTemplate>
        ...
        <NSkeletonItem shape="operate"></NSkeletonItem>
        <NSkeletonItem shape="button"></NSkeletonItem>
        <NSkeletonItem shape="image"></NSkeletonItem>
      ...
      <template #default>
        ...
        <div>
          <img
            ...
            src="https://www.nio.cn/cdh-static/mynio/images/nio-day-2021/nio-day-2021-playback-desktop.jpg"
          />
        </div>
        <div class="container">
          <img
