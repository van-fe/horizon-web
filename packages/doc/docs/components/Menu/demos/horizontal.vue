...
const theme = ref<menuPropType['theme']>('midnight');
const activeType = ref<menuPropType['activeType']>('button');
const submenuExpandType = ref<menuPropType['submenuExpandType']>('single');
