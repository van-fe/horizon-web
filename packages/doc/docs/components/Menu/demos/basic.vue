    ...
    <n-col :span="24">
      ...
      >
        ...
        <n-form-item label="action:">
          <n-button size="small" @click="expandAll">Expand All</n-button>
          <n-button size="small" @click="collapseAll">Collapse All</n-button>
        </n-form-item>
        <!-- <n-form-item label="collapseShowTitle:">
          <n-checkbox v-model="collapseShowTitle" />
        </n-form-item> -->
      </n-form>
    </n-col>
  </n-row>
            ...
            <n-sub-menu value="3" icon="matestore_filled">
              ...
              <n-sub-menu value="3-3">
                ...
                <n-sub-menu value="3-3-2">
                  ...
                  <n-sub-menu value="3-3-2-2">
                    <template #title>四级菜单 2</template>
                    <n-menu-item value="3-3-2-2-1">五级菜单 1</n-menu-item>
                    <n-menu-item value="3-3-2-2-2">五级菜单 2</n-menu-item>
                    <n-menu-item value="3-3-2-2-3">五级菜单 3</n-menu-item>
                  </n-sub-menu>
                </n-sub-menu>
              </n-sub-menu>
            </n-sub-menu>
...
const theme = ref<ExtractPropTypes<typeof useMenuProps>['theme']>('gray');
const selectedValue = ref('3-1-2');
const collapseShowTitle = ref(true);
