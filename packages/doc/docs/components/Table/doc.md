...
:::demo ./demos/multiple-header.vue :::
...
:::demo ./demos/expand.vue :::

### 嵌套表格
在展开行的基础上，可以实现嵌套表格，用于将一些次要信息但是数组形式的数据展示的需求
:::demo ./demos/nested-tables.vue :::
...
:::demo ./demos/tree-single-selection.vue :::
...
:::demo ./demos/tree-multiple-selection.vue :::
...
### 类型定义
:::code ../../../../lego/src/components/Table/src/utils/types.ts :::