<template>
  <h-row :gutter="10">
    <h-col :span="6">
      ...
      <h-modal-select v-model="value1" :to-body="false" :to-body="false">
        ...
        <template #tagRender="slotProps">
          <div style="height: 100px; display: flex; aligh-items: center">
    ...
    <h-col :span="6">
      ...
      <h-modal-select v-model="value2" :value-format="valueFormat" :to-body="false">
