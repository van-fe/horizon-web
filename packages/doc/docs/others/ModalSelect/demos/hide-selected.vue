<template>
  <n-row :gutter="10">
    <n-col :span="6">
      ...
      <n-modal-select v-model="value3" :selected-visible="false" clearable :to-body="false">
    ...
    <n-col :span="6">
      ...
      <n-modal-select v-model="values4" :selected-visible="false" clearable multiple :to-body="false">
        <n-option label="上海" :value="1" />
        <n-option :value="2" label="北京" />
        <n-option :value="3" label="合肥" name="hefei" />
      </n-modal-select>
