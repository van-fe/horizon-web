<template>
  <h-row>
    <h-col :xs="12" :md="8" :lg="6" :xl="6" :xxl="6">
      ...
      <h-modal-select v-model="value1" :initial-value="null" :clearable="true" :to-body="false">
    ...
    <h-col :xs="12" :md="8" :lg="6" :xl="6" :xxl="6">
      ...
      <h-modal-select v-model="value2" :multiple="true" :initial-value="[]" :to-body="false" :clearable="true">
        <h-option v-for="item of selectOptions" :key="item.value" :value="item.value" :label="item.label" />
      </h-modal-select>
    </h-col>
  </h-row>
