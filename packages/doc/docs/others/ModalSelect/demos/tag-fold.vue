<template>
  <h-row :gutter="10">
    <h-col :span="6">
      ...
      <h-modal-select v-model="values4" collapse multiple :to-body="false">
    ...
    <h-col :span="6">
      ...
      <h-modal-select v-model="values5" filter-option collapse multiple :max-tag-width="200" :to-body="false">
        <h-option label="齐齐哈尔" :value="1" />
        <h-option :value="2" label="那然色布斯台音布拉格" />
        <h-option label="上海" :value="3" />
        <h-option :value="4" label="北京" />
    ...
    <h-col :span="6">
      ...
      <h-modal-select v-model="values6" allow-create collapse multiple :to-body="false">
        <h-option label="齐齐哈尔" :value="1" />
        <h-option :value="2" label="那然色布斯台音布拉格" />
        <h-option label="上海" :value="3" />
        <h-option :value="4" label="北京" />
