...
import { cls, ComponentClassBlock, type LegoComponentInstance, useNamespace } from '@nio-fe/shared';
...
import { NTagGroup } from '~/components/Tag';
import useSize from '~/utils/useSize';
import NPickerFitContentInput from '~/components/Picker/src/components/NPickerFitContentInput';
import useLocaleLang from '~/utils/useLocaleLang';
import { NFormItemErrorInjectedKey } from '~/components/Form';
import Tree, { type NTree } from '~/components/Tree';
...
export default defineComponent({
  ...
  setup(props: TreeSelectProps, context: NTreeSelectContext) {
    ...
    const { needConfirm, confirmBtnText, cancelBtnText, confirmHandle, cancelHandle } = useConfirm(
      refProps,
      context,
      domRefs,
      modelValueSet,
