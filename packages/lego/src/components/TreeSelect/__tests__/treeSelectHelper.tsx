import type { MaybeRef, LegoComponentInstance, ExtractSlotTypes, Arrayable } from '@nio-fe/shared';
import { Fragment, nextTick, ref, unref } from 'vue';
import type { DOMWrapper, VueWrapper } from '@vue/test-utils';
import { mount } from '@vue/test-utils';
import { NTreeSelect } from '~/components/TreeSelect';
...
> {
  ...
  private readonly slots: Partial<ExtractSlotTypes<TreeSelectSlots>>;
  ...
  constructor(
    ...
    slots: Partial<ExtractSlotTypes<TreeSelectSlots>> = {},
  ) {
