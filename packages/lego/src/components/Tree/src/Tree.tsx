...
import { ComponentClassBlock, cls, useNamespace, cssVariable } from '@nio-fe/shared';
...
import useHighlightMethod from './utils/useHighlight';
import useDynamicLoad from './utils/useDynamicLoad';
import useTreeData from './utils/useTreeData';
import useExpand from './utils/useExpand';
import useCheckable from './utils/useCheckable';
import useFilter from './utils/useFilter';
import isEqual from 'lodash/isEqual';
import useVNodeCollection from './utils/useVNodeCollection';
...
export default defineComponent({
  ...
  setup(
    ...
    provide(NTreeHighlightMethodInjectKey, useHighlightMethod(refProps, tree));
