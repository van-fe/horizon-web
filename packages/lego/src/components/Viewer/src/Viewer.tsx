...
import { ComponentClassBlock, useNamespace, useZIndex } from '@nio-fe/shared';
import { NIcon, IconLoadingLine, IconPlayFilled } from '@nio-fe/icon';
                    ...
                    toolBtnList.value.map(tool => {
                      switch (tool) {
                            ...
                            <button
                              v-tooltip={
                                showThumbnailRef.value
                                  ? locale.value?.langService.td().lego.viewer.closeThumbnail
                                  : locale.value?.langService.td().lego.viewer.thumbnail
                              }
                              type="button"
                        ...
                        case 'previous':
                          return (
                            <button
                              v-tooltip={locale.value?.langService.td().lego.viewer.previous}
                              type="button"
                        ...
                        case 'next':
                          return (
                            <button
                              v-tooltip={locale.value?.langService.td().lego.viewer.next}
                              type="button"
                              onClick={goToNext}
                        ...
                        case 'zoomOut':
                          return (
                            <button
                              v-tooltip={locale.value?.langService.td().lego.viewer.zoomOut}
                              type="button"
                              onClick={zoomOut}
                            >
                        ...
                        case 'zoomIn':
                          return (
                            <button
                              v-tooltip={locale.value?.langService.td().lego.viewer.zoomIn}
                              type="button"
                              onClick={zoomIn}
                            >
                        ...
                        case '1:1':
                          return (
                            <button
                              v-tooltip={
                                originIconRef.value
                                  ? locale.value?.langService.td().lego.viewer.fitContent
                                  : '1:1'
                              }
                              type="button"
                              onClick={adaptClick}
                        ...
                        case 'rotate':
                          return (
                            <button
                              v-tooltip={locale.value?.langService.td().lego.viewer.spin}
                              type="button"
                              onClick={rotate}
                            >
                          ...
                          if (currentSource.value.type === 'image' && currentSource.value.legends) {
                            return (
                              <button
                                v-tooltip={
                                  showLegendRef.value
                                    ? locale.value?.langService.td().lego.viewer.hideLabel
                                    : locale.value?.langService.td().lego.viewer.displayLabel
                                }
                                type="button"
                        ...
                        case 'download':
                          return (
                            <button
                              v-tooltip={locale.value?.langService.td().lego.viewer.download}
                              type="button"
                              onClick={download}
                            >
