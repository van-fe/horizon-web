...
export const useTableProps = declarePropType({
  ...
  /**
   * 表格高度，默认根据表格数据自适应。 会使用 `@nio-fe/shared.sizeUnitTransform` 转化尺寸
   */
  height: {
    type: [String, Number],
  },
  /**
   * 表格最小高度。 会使用 `@nio-fe/shared.sizeUnitTransform` 转化尺寸
   */
  minHeight: {
    type: [String, Number],
  },
  /**
   * 表格最大高度。 会使用 `@nio-fe/shared.sizeUnitTransform` 转化尺寸
   */
  maxHeight: {
    type: [String, Number],
  },
