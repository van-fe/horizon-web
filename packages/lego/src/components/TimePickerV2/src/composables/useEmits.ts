...
export const useTimePickerV2Emits = {
  /**
   * 更新日期
...
export const useTimePickerV2TimePanelEmit = {
  /**
   * 更新日期
   * @param val 当前值
   * @param triggerType 触发方式
...
export const useTimePickerV2TimeColumnPanelEmit = {
  /**
   * 更新值
   * @param val 当前值
   * @param triggerType 触发方式
...
export type TimePickerV2Emits = typeof useTimePickerV2Emits;
export type TimePickerV2TimePanelEmits = typeof useTimePickerV2TimePanelEmit;
export type TimePickerV2TimeColumnPanelEmits = typeof useTimePickerV2TimeColumnPanelEmit;
