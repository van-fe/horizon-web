...
import { cls, ComponentClassBlock, isDefined } from '@nio-fe/shared';
import type { TimePickerV2TimePanelProps } from '../composables/useProps';
import { useTimePickerV2TimePanelProps } from '../composables/useProps';
...
import type { TimePickerV2TimePanelEmits } from '../composables/useEmits';
import { useTimePickerV2TimePanelEmit } from '../composables/useEmits';
import type {
  TimePickerV2TimeColumnPanelExposes,
  TimePickerV2TimePanelExposes,
} from '../composables/useExposes';
import { useTimePickerV2TimePanelExposes } from '../composables/useExposes';
import type { Dayjs } from 'dayjs';
import { NTimePickerV2EmitsInjectKey } from '../utils/injectKeys';

export default defineComponent({
  name: 'TimePanel',
  props: useTimePickerV2TimePanelProps,
  emits: useTimePickerV2TimePanelEmit,
  exposes: useTimePickerV2TimePanelExposes,
  setup(
    props: TimePickerV2TimePanelProps,
    {
      emit,
      expose,
    }: LegoSetupContext<TimePickerV2TimePanelEmits, {}, TimePickerV2TimePanelExposes>,
  ) {
    const classHelper = new ComponentClassBlock('time-picker-v2');

    const parentEmit = inject(NTimePickerV2EmitsInjectKey, undefined);

    const timePanelDomRef =
      ref<LegoComponentInstance<typeof TimeColumnPanel, TimePickerV2TimeColumnPanelExposes>>();
