...
import { isDefined, cls, ComponentClassBlock } from '@nio-fe/shared';
import NScrollbar from '~/components/Scrollbar/src/Scrollbar';
import type { NTimePickerPanelOptionType, NTimePickerV2ShowTimeTooltipType } from '../utils/types';
import type { ScrollbarExposes } from '~/components/Scrollbar/src/composables/useExposes';
import { unrefElement } from '@vueuse/core';
import type { TimePickerV2TimeColumnPanelExposes } from '../composables/useExposes';
import { useTimePickerV2TimeColumnPanelExposes } from '../composables/useExposes';
import type { TimePickerV2TimeColumnPanelEmits } from '../composables/useEmits';
import { useTimePickerV2TimeColumnPanelEmit } from '../composables/useEmits';
...
export default defineComponent({
  ...
  props: {
    ...
    showTimeTooltip: {
      type: Function as PropType<NTimePickerV2ShowTimeTooltipType>,
    },
    previewTime: {
  ...
  emits: useTimePickerV2TimeColumnPanelEmit,
  exposes: useTimePickerV2TimeColumnPanelExposes,
  setup(
    props,
    {
      emit,
      expose,
    }: LegoSetupContext<TimePickerV2TimeColumnPanelEmits, {}, TimePickerV2TimeColumnPanelExposes>,
  ) {
