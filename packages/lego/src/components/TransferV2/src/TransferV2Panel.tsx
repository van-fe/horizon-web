...
import type { TransferV2PanelSlots } from './composables/useSlots';
import { useTransferV2PanelSlots } from './composables/useSlots';
...
export default defineComponent({
  ...
  slots: useTransferV2PanelSlots,
  setup(
    props: TransferV2PanelProps,
    { slots, emit, expose }: LegoSetupContext<TransferV2PanelEmits, TransferV2PanelSlots>,
  ) {
