...
export const useTransferV2Props = declarePropType({
  /**
   * 	Transfer 的数据源
   */
  data: {
...
export const useTransferV2PanelProps = declarePropType({
  /**
   * 数据
   */
  data: {
...
export type TransferV2Props = ExtractPropTypes<typeof useTransferV2Props>;
export type TransferV2PanelProps = ExtractPropTypes<typeof useTransferV2PanelProps>;
