...
export const useTransferV2Slots = Object as SlotsType<{
  /**
   * 左侧列表头部的内容
   */
  leftHeader?: {};
...
export const useTransferV2PanelSlots = Object as SlotsType<{
  /**
   * 头部内容
   */
  header?: {};
...
export type TransferV2PanelSlots = typeof useTransferV2PanelSlots;
