...
import { IconArrowRight, IconCheck, NIconSVG } from '@nio-fe/icon';
  ...
  setup(props) {
    ...
    return () => {
      const filterResultContent = parentSlots.searchPanelRender ? (
        ...
        <div
          class={classHelper.e('content')}
          v-html={props.extendsOption.labels
            .join(' / ')
            .replace(
              new RegExp(transformRegString(inputString.value), 'ig'),
