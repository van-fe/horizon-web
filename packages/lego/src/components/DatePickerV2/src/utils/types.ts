...
import type { DatePickerV2DatePanelExposes } from '../composables/useExposes';
...
export type NDatePickerV2BaseSupportType =
  | 'year'
  | 'month'
  | 'week'
  | 'date'
...
export type NDatePickerV2TypeFormat<T extends string> =
  | T
  | KebabCaseToCamelCase<T>
  | KebabCaseToLowerCase<T>;

/**
 * date-picker-v2 support the NDatePickerV2BaseSupportType, and its lowercase and camelcase.
 */
export type NDatePickerV2SupportType = NDatePickerV2TypeFormat<NDatePickerV2BaseSupportType>;
 ...
 */
export type NDatePickerV2AccessDatetimeType = ConfigType;
 ...
 */
export type NDatePickerV2DisabledDateMethodType = (date: Dayjs) => boolean;
 ...
 */
export type NDatePickerV2DisabledTimeMethodType = (time: Dayjs) => boolean;
 ...
 */
export type NDatePickerV2ShowDotType = (
  date: Dayjs,
 ...
 * Shortcuts config
 */
export interface NDatePickerV2ShortcutsType {
  /**
 ...
 */
export type NDatePickerV2ShowDateTooltipType = (date: Dayjs) => {
  show: boolean;
  content?: string;
};
 ...
 * It's as same as NTimePickerV2's show-time-tooltip.
 */
export type NDatePickerV2ShowTimeTooltipType = (
  time: Dayjs,
 ...
 */
export interface NDatePickerV2DateCellType {
  /**
...
export interface NDatePickerDomRefs {
  startDatePanelsDomRef: Ref<
    LegoComponentInstance<typeof DatePanel, DatePickerV2DatePanelExposes> | undefined
  >;
