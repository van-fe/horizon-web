...
export const useDatePickerV2Slots = Object as SlotsType<{
  /**
   * 自定义日单元格内容
   * @param grid 内容请参考【类型定义】
   */
  default?: { grid: NDatePickerV2DateCellType };
  /**
   * 自定义月单元格内容
   * @param grid 内容请参考【类型定义】
   */
  month?: { grid: NDatePickerV2DateCellType };
  /**
   * 自定义年单元格内容
   * @param grid 内容请参考【类型定义】
   */
  year?: { grid: NDatePickerV2DateCellType };
  /**
   * 时间范围分隔符
   */
  rangeSeparator?: {};
