...
import { IconClose, IconSwapRight } from '@nio-fe/icon';
import type {
...
export const useDatePickerV2Props = declarePropType({
  /**
   * 双向绑定值
   */
  modelValue: {
    type: [Date, String, Number, Object, Array] as PropType<
      | NDatePickerV2AccessDatetimeType
      | [NDatePickerV2AccessDatetimeType, NDatePickerV2AccessDatetimeType]
    >,
  },
  /**
   * 面板类型
   ...
   */
  type: {
    type: String as PropType<NDatePickerV2SupportType>,
    default: 'date',
  },
  /**
   * 是否禁用
   ...
   */
  disabledDate: {
    type: Function as PropType<NDatePickerV2DisabledDateMethodType>,
  },
  /**
   * 设置禁选时间
   * 详见类型定义
   */
  disabledTime: {
    type: Function as PropType<NDatePickerV2DisabledTimeMethodType>,
  },
  /**
   * 在时间范围选择时，设置开始的禁选时间
   */
   ...
   */
  shortcuts: {
    type: Array as PropType<NDatePickerV2ShortcutsType[]>,
  },
  /**
   * 是否固定显示6行日期
   */
   ...
   */
  showDateTooltip: {
    type: Function as PropType<NDatePickerV2ShowDateTooltipType>,
  },
  /**
   * 月格子显示提示文字的方法
   */
   ...
   */
  showTimeTooltip: {
    type: Function as PropType<NDatePickerV2ShowTimeTooltipType>,
  },
  /**
   * 面板展示的日期，默认为当前日期
   ...
   */
  showDot: {
    type: Function as PropType<NDatePickerV2ShowDotType>,
  },
  /**
   * 弹窗最小宽度
   * 普通选择: 160
...
export const useDatePickerV2DatePanelProps = declarePropType({
  /**
   * 开始日期
   */
  startDate: {
...
export const useDatePickerV2DatePanelComponentsProps = declarePropType({
  /**
   * 开始日期
   */
  startDate: {
...
export const useDatePickerV2DatetimeTriggerHeaderProps = declarePropType({
  /**
   * 日期
   */
  date: {
...
export type DatePickerV2Props = ExtractPropTypes<typeof useDatePickerV2Props>;
export type DatePickerV2DatePanelProps = ExtractPropTypes<typeof useDatePickerV2DatePanelProps>;
export type DatePickerV2DatePanelComponentsProps = ExtractPropTypes<
  typeof useDatePickerV2DatePanelComponentsProps
>;
export type DatePickerV2DatetimeTriggerHeaderProps = ExtractPropTypes<
  typeof useDatePickerV2DatetimeTriggerHeaderProps
>;
