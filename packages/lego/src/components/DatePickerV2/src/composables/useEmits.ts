...
import { isBoolean, isNil, isObject, isString, isUndefined } from '@nio-fe/shared';
import type { NDatePickerV2ShortcutsType } from '../utils/types';

export const useDatePickerV2Emits = {
  /**
   * 更新日期 | undefined | null
   ...
   * @param evt 输入事件
   */
  input: (val: string, evt: InputEvent) => isString(val) && evt instanceof InputEvent,
  /**
   * 聚焦时触发
   */
  focus: () => true,
   ...
   */
  shortcutClick: (shortcut: NDatePickerV2ShortcutsType) => isObject(shortcut),
};

export const useDatePickerV2DatePanelEmit = {
  /**
   * 更新日期
...
export const useDatePickerV2DatePanelTriggerHeaderEmit = {
  /**
   * 更新时间
   * @param val 时间
   * @param triggerType 触发方式
...
export const useDatePickerV2DatePanelComponentsEmit = {
  /**
   * 点击日期格子
   * @param date 日期
   * @param triggerType 触发方式
...
export type DatePickerV2Emits = typeof useDatePickerV2Emits;
export type DatePickerV2DatePanelEmits = typeof useDatePickerV2DatePanelEmit;
export type DatePickerV2DatePanelTriggerHeaderEmits =
  typeof useDatePickerV2DatePanelTriggerHeaderEmit;
export type DatePickerV2TimePanelComponentsEmits = typeof useDatePickerV2DatePanelComponentsEmit;
