...
export default defineComponent({
  ...
  setup(
    props: DatePickerV2DatePanelProps,
    {
      emit,
      expose,
    }: LegoSetupContext<DatePickerV2DatePanelEmits, {}, DatePickerV2DatePanelHeaderExposes>,
  ) {
    const classHelper = new ComponentClassBlock('date-picker-v2-panel-header');

    const triggerHeaderDomRef =
      ref<
        LegoComponentInstance<typeof DatetimeTriggerHeader, DatePickerV2DatePanelHeaderExposes>
      >();
