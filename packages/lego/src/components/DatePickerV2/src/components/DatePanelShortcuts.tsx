...
import { cls, ComponentClassBlock, isUndefined } from '@nio-fe/shared';
import {
  NDatePickerV2EmitsInjectKey,
  NDatePickerV2FormatInjectKey,
  NDatePickerV2PropsInjectKey,
} from '../utils/injectKeys';
import type { GetableType, NDatePickerV2ShortcutsType } from '../utils/types';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    function handleClick(shortcut: NDatePickerV2ShortcutsType) {
