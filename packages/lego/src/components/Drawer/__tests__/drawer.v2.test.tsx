            ...
            <div class=\\"n-drawer__main\\">
              <div class=\\"n-drawer__header n-drawer__header--customize\\">
                <div class=\\"n-drawer__default-title\\">
                  ...
                  <div class=\\"n-button__icon is-custom-size\\"><i class=\\"n-icon n-icon__v2_11_2 n-icon_close\\" style=\\"font-size: 16px; transform: rotate(undefineddeg);\\"></i></div>
                  <!---->
                  <!---->
                </button>
              </div>
              <div class=\\"n-drawer__body\\"><input></div>
