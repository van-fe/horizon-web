import type { ExtractSlotTypes, LegoComponentInstance, MaybeRef } from '@nio-fe/shared';
...
import { NAutoComplete } from '~/components/AutoComplete';
...
> {
  ...
  public slots?: Partial<ExtractSlotTypes<AutoCompleteSlots>>;
  ...
  constructor(
    ...
    slots?: Partial<ExtractSlotTypes<AutoCompleteSlots>>,
  ) {
