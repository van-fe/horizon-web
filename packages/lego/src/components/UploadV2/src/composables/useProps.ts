...
export const useUploadV2Props = declarePropType({
  /**
   * 唯一标识符
   * 会标注在 `input` 上
   * 在后台上传时，也可以标注其具体归属
   ...
   */
  modelValue: {
    type: [Object, Array] as PropType<Arrayable<NUploadV2RawFileType> | null>,
  },
  /**
   * 上传类型
  ...
  controls: {
    type: [Array, Function] as PropType<
      | ('upload' | 'delete' | 'view')[]
      | ((file: UnwrapRef<NUploadV2FileType>) => ('upload' | 'delete' | 'view')[])
    >,
   ...
   */
  beforeUpload: {
    type: Function as PropType<(file: NUploadV2FileType) => Promisable<boolean>>,
  },
  /**
   ...
   */
  beforePreview: {
    type: Function as PropType<(file: NUploadV2FileType) => Promisable<boolean | void>>,
  },
  /**
   ...
   */
  beforeViewerPreview: {
    type: Function as PropType<(file: NUploadV2FileType) => boolean>,
  },
  /**
   ...
   */
  handleSuccess: {
    type: Function as PropType<(responseData: any, file: NUploadV2FileType) => Promisable<string>>,
  },
  /**
   * 最大同时上传数量
   */
  ...
  /**
   * 覆盖默认的上传函数
   * 需参考 [uploadFileDirectly](https://git.nevint.com/lego/lego/-/blob/master/packages/lego/src/components/UploadV2/src/utils/UploadHelper.ts) 的行为
   * @version 2.9.4
   */
  httpRequest: {
    type: Function as PropType<
      (file: NUploadV2FileType, instanceMethods: NUploadV2HttpRequestInstanceMethods) => void
    >,
  },
  /**
   * 是否显示文件大小
...
export const useUploadV2BackgroundProps = declarePropType({
  /**
   * 唯一标识
   */
  id: {
   ...
   */
  uploadProps: {
    type: Object as PropType<UploadV2Props>,
  },
});

export type UploadV2Props = ExtractPropTypes<typeof useUploadV2Props>;
export type UploadV2BackgroundProps = ExtractPropTypes<typeof useUploadV2BackgroundProps>;
