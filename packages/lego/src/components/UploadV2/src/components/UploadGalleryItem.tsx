...
import { NMask } from '~/components/Mask';
...
import { IconPictureError, IconVideo } from '@nio-fe/icon';
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const parentProps = inject(NUploadV2PropsInjectKey)!;
        ...
        switch (props.file.status) {
          case NUploadV2FileStatusEnum.Success:
            switch (props.file.type) {
              case NUploadV2FileTypeEnum.Image:
                return (
              ...
              case NUploadV2FileTypeEnum.Video:
                return (
                  <div class={classHelper.em('item', 'success')}>
