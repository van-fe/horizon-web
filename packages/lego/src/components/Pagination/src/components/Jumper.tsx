...
import { ComponentClassBlock, isNumber, useNamespace } from '@nio-fe/shared';
    ...
    return () => (
      <div class={classHelper.e('jumper')}>
        {parentProps.label?.jumpPrefixText ??
          ...
          locale.value?.langService.td().lego.pagination.goto}
        <NInputNumber
          ref={inputNumberRef}
        ...
        {parentProps.label?.jumpSuffixText ??
          ...
          locale.value?.langService.td().lego.pagination.pageClassifier}
      </div>
    );
  },
});
