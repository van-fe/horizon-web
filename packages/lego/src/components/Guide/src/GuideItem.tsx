...
import { ComponentClassBlock, cls, useNamespace, getElement } from '@nio-fe/shared';
...
export default defineComponent({
  ...
  setup(
    ...
    { emit, slots, expose }: LegoSetupContext<GuideItemEmits, GuideItemSlots, GuideItemExposes>,
  ) {
