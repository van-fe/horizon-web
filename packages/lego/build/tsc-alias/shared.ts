...
export default function replaceShared(params: AliasReplacerArguments) {
  if (params.orig.includes('node_modules')) {
    ...
    if (pkgName) {
      ...
      throw new Error(`Uncought package import path: ${params.orig}. You should add this pkgName to 'packages/lego/build/tsc-alias/shared.ts' file's mapping variable.`)
    }
  }
